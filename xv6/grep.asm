 ...
 1f4:	31 ff                	xor    %edi,%edi
{
 ...
 21d:	50                   	push   %eax
 21e:	8d 81 80 12 00 00    	lea    0x1280(%ecx),%eax
 224:	50                   	push   %eax
 ...
 23b:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    buf[m] = '\0';
 23e:	bf 80 12 00 00       	mov    $0x1280,%edi
 243:	89 de                	mov    %ebx,%esi
 245:	c6 81 80 12 00 00 00 	movb   $0x0,0x1280(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 2f2:	81 ff 80 12 00 00    	cmp    $0x1280,%edi
 ...
 307:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 30a:	2d 80 12 00 00       	sub    $0x1280,%eax
 30f:	29 45 e0             	sub    %eax,-0x20(%ebp)
 312:	8b 4d e0             	mov    -0x20(%ebp),%ecx
      memmove(buf, p, m);
 315:	51                   	push   %ecx
 316:	57                   	push   %edi
 317:	68 80 12 00 00       	push   $0x1280
 ...
 698:	89 d1                	mov    %edx,%ecx
{
 ...
 6cb:	0f b6 92 cc 0d 00 00 	movzbl 0xdcc(%edx),%edx
 ...
 739:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 7a4:	ff 24 85 74 0d 00 00 	jmp    *0xd74(,%eax,4)
 ...
 8b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 8b5:	bb 6a 0d 00 00       	mov    $0xd6a,%ebx
...
free(void *ap)
{
 ...
 8c1:	a1 80 16 00 00       	mov    0x1680,%eax
{
 ...
 8ff:	5b                   	pop    %ebx
  freep = p;
 900:	a3 80 16 00 00       	mov    %eax,0x1680
}
 905:	5e                   	pop    %esi
 906:	5f                   	pop    %edi
 907:	5d                   	pop    %ebp
 ...
 916:	72 ce                	jb     8e6 <free+0x26>
{
 ...
 937:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 93a:	a3 80 16 00 00       	mov    %eax,0x1680
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 959:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 95c:	8b 15 80 16 00 00    	mov    0x1680,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 99b:	3b 05 80 16 00 00    	cmp    0x1680,%eax
 ...
 9be:	e8 fd fe ff ff       	call   8c0 <free>
  return freep;
 9c3:	8b 15 80 16 00 00    	mov    0x1680,%edx
 ...
 9ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 9ef:	89 15 80 16 00 00    	mov    %edx,0x1680
}
 ...
 9ff:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 a00:	c7 05 80 16 00 00 84 	movl   $0x1684,0x1680
 a07:	16 00 00 
    base.s.size = 0;
 a0a:	b8 84 16 00 00       	mov    $0x1684,%eax
    base.s.ptr = freep = prevp = &base;
 a0f:	c7 05 84 16 00 00 84 	movl   $0x1684,0x1684
 a16:	16 00 00 
    base.s.size = 0;
 a19:	c7 05 88 16 00 00 00 	movl   $0x0,0x1688
 a20:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 a40:	b8 c0 16 00 00       	mov    $0x16c0,%eax
 a45:	8d 76 00             	lea    0x0(%esi),%esi
    table[i].state = FREE;
 a48:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 a4e:	83 c0 20             	add    $0x20,%eax
    table[i].state = FREE;
 a51:	c7 40 f0 00 00 00 00 	movl   $0x0,-0x10(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 a58:	3d c0 17 00 00       	cmp    $0x17c0,%eax
 a5d:	75 e9                	jne    a48 <thread_init+0x8>
 
  table[0].state = RUNNING;
  table[0].tid   = next_tid++;
 a5f:	a1 78 12 00 00       	mov    0x1278,%eax
  table[0].state = RUNNING;
 a64:	c7 05 c0 16 00 00 02 	movl   $0x2,0x16c0
 a6b:	00 00 00 
  table[0].stack = 0;   
 a6e:	c7 05 c8 16 00 00 00 	movl   $0x0,0x16c8
 a75:	00 00 00 
  table[0].tid   = next_tid++;
 a78:	8d 50 01             	lea    0x1(%eax),%edx
 a7b:	a3 c4 16 00 00       	mov    %eax,0x16c4
 a80:	89 15 78 12 00 00    	mov    %edx,0x1278
  table[0].ctx   = &main_ctx;
 a86:	c7 05 cc 16 00 00 a0 	movl   $0x16a0,0x16cc
 a8d:	16 00 00 
  current = 0;
 a90:	c7 05 b4 16 00 00 00 	movl   $0x0,0x16b4
 a97:	00 00 00 
}
 a9a:	c3                   	ret
 a9b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 ab2:	c1 e3 04             	shl    $0x4,%ebx
 ab5:	8b 93 c0 16 00 00    	mov    0x16c0(%ebx),%edx
 abb:	85 d2                	test   %edx,%edx
 abd:	74 19                	je     ad8 <thread_create+0x38>
  for (int i = 1; i < MAX_THREADS; i++) {
 abf:	83 c0 01             	add    $0x1,%eax
 ac2:	83 f8 10             	cmp    $0x10,%eax
 ac5:	75 e9                	jne    ab0 <thread_create+0x10>
  }
  if (slot == -1) return -1;
 ac7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 acc:	e9 98 00 00 00       	jmp    b69 <thread_create+0xc9>
 ...
 ae0:	e8 6b fe ff ff       	call   950 <malloc>
  if (!stk) return -1;
 ...
 aec:	74 d9                	je     ac7 <thread_create+0x27>
  memset(stk, 0, STACK_SIZE);
 aee:	83 ec 04             	sub    $0x4,%esp
 af1:	68 00 20 00 00       	push   $0x2000
 af6:	6a 00                	push   $0x0
 af8:	56                   	push   %esi
 af9:	e8 62 f9 ff ff       	call   460 <memset>
 ...
 b01:	89 b3 c8 16 00 00    	mov    %esi,0x16c8(%ebx)
  table[slot].ctx   = (struct context*)sp;

  return table[slot].tid;
 b07:	83 c4 10             	add    $0x10,%esp
  sp--;  *sp = 0xffffffff;
 b0a:	c7 86 f4 1f 00 00 ff 	movl   $0xffffffff,0x1ff4(%esi)
 b11:	ff ff ff 
  sp--;  *sp = 0;   /* edi */
 b14:	81 c6 e0 1f 00 00    	add    $0x1fe0,%esi
  sp--;  *sp = (uint)arg;
 b1a:	89 46 1c             	mov    %eax,0x1c(%esi)
  sp--;  *sp = (uint)fn;
 b1d:	8b 45 08             	mov    0x8(%ebp),%eax
  sp--;  *sp = (uint)thread_stub;
 b20:	c7 46 10 10 0c 00 00 	movl   $0xc10,0x10(%esi)
  sp--;  *sp = (uint)fn;
 b27:	89 46 18             	mov    %eax,0x18(%esi)
  table[slot].tid   = next_tid++;
 b2a:	a1 78 12 00 00       	mov    0x1278,%eax
  sp--;  *sp = 0;   /* ebp */
 b2f:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
  table[slot].tid   = next_tid++;
 b36:	8d 48 01             	lea    0x1(%eax),%ecx
  sp--;  *sp = 0;   /* ebx */
 b39:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)
  sp--;  *sp = 0;   /* esi */
 b40:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
  sp--;  *sp = 0;   /* edi */
 b47:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  table[slot].state = RUNNABLE;
 b4d:	c7 83 c0 16 00 00 01 	movl   $0x1,0x16c0(%ebx)
 b54:	00 00 00 
  table[slot].tid   = next_tid++;
 b57:	89 0d 78 12 00 00    	mov    %ecx,0x1278
 b5d:	89 83 c4 16 00 00    	mov    %eax,0x16c4(%ebx)
  sp--;  *sp = 0;   /* edi */
 b63:	89 b3 cc 16 00 00    	mov    %esi,0x16cc(%ebx)
}
 b69:	8d 65 f8             	lea    -0x8(%ebp),%esp
 b6c:	5b                   	pop    %ebx
 b6d:	5e                   	pop    %esi
 b6e:	5d                   	pop    %ebp
 b6f:	c3                   	ret
...
void thread_yield(void) {
 ...
 b75:	8b 35 b4 16 00 00    	mov    0x16b4,%esi
 b7b:	8d 4e 01             	lea    0x1(%esi),%ecx
 b7e:	8d 5e 11             	lea    0x11(%esi),%ebx
 b81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 b88:	89 ca                	mov    %ecx,%edx
 b8a:	c1 fa 1f             	sar    $0x1f,%edx
 b8d:	c1 ea 1c             	shr    $0x1c,%edx
 b90:	8d 04 11             	lea    (%ecx,%edx,1),%eax
 b93:	83 e0 0f             	and    $0xf,%eax
 b96:	29 d0                	sub    %edx,%eax
    if (table[idx].state == RUNNABLE)
 b98:	89 c2                	mov    %eax,%edx
 b9a:	c1 e2 04             	shl    $0x4,%edx
 b9d:	83 ba c0 16 00 00 01 	cmpl   $0x1,0x16c0(%edx)
 ba4:	74 12                	je     bb8 <thread_yield+0x48>
  for (int i = 1; i <= MAX_THREADS; i++) {
 ba6:	83 c1 01             	add    $0x1,%ecx
 ba9:	39 d9                	cmp    %ebx,%ecx
 bab:	75 db                	jne    b88 <thread_yield+0x18>
 ...
 bbb:	74 f0                	je     bad <thread_yield+0x3d>
  if (table[prev].state == RUNNING)
 bbd:	89 f2                	mov    %esi,%edx
 bbf:	c1 e2 04             	shl    $0x4,%edx
 bc2:	83 ba c0 16 00 00 02 	cmpl   $0x2,0x16c0(%edx)
 bc9:	75 0a                	jne    bd5 <thread_yield+0x65>
    table[prev].state = RUNNABLE;
 bcb:	c7 82 c0 16 00 00 01 	movl   $0x1,0x16c0(%edx)
 bd2:	00 00 00 
  table[next].state = RUNNING;
 bd5:	89 c2                	mov    %eax,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 bd7:	c1 e6 04             	shl    $0x4,%esi
 bda:	83 ec 08             	sub    $0x8,%esp
  current = next;
 bdd:	a3 b4 16 00 00       	mov    %eax,0x16b4
  table[next].state = RUNNING;
 be2:	c1 e2 04             	shl    $0x4,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 be5:	81 c6 cc 16 00 00    	add    $0x16cc,%esi
  table[next].state = RUNNING;
 beb:	c7 82 c0 16 00 00 02 	movl   $0x2,0x16c0(%edx)
 bf2:	00 00 00 
  uswtch(&table[prev].ctx, table[next].ctx);
 bf5:	ff b2 cc 16 00 00    	push   0x16cc(%edx)
 bfb:	56                   	push   %esi
 bfc:	e8 1d 01 00 00       	call   d1e <uswtch>
 ...
 c09:	5d                   	pop    %ebp
 c0a:	c3                   	ret
 c0b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
...
static void thread_stub(void (*fn)(void*), void *arg) {
 ...
 c13:	83 ec 14             	sub    $0x14,%esp
  fn(arg);
 c16:	ff 75 0c             	push   0xc(%ebp)
 c19:	ff 55 08             	call   *0x8(%ebp)
  table[current].state = ZOMBIE;
 c1c:	a1 b4 16 00 00       	mov    0x16b4,%eax
 c21:	c1 e0 04             	shl    $0x4,%eax
 c24:	c7 80 c0 16 00 00 03 	movl   $0x3,0x16c0(%eax)
 c2b:	00 00 00 
  thread_yield();
 c2e:	e8 3d ff ff ff       	call   b70 <thread_yield>
  exit();
 c33:	e8 ab f9 ff ff       	call   5e3 <exit>
...
int thread_join(tid_t tid) {
 ...
 c45:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  int slot = -1;
  for (int i = 0; i < MAX_THREADS; i++) {
 c48:	31 db                	xor    %ebx,%ebx
 c4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if (table[i].tid == tid) { slot = i; break; }
 c50:	89 de                	mov    %ebx,%esi
 c52:	c1 e6 04             	shl    $0x4,%esi
 c55:	39 86 c4 16 00 00    	cmp    %eax,0x16c4(%esi)
 c5b:	74 20                	je     c7d <thread_join+0x3d>
  for (int i = 0; i < MAX_THREADS; i++) {
 c5d:	83 c3 01             	add    $0x1,%ebx
 c60:	83 fb 10             	cmp    $0x10,%ebx
 c63:	75 eb                	jne    c50 <thread_join+0x10>
 ...
 c7d:	83 be c0 16 00 00 03 	cmpl   $0x3,0x16c0(%esi)
 c84:	75 f2                	jne    c78 <thread_join+0x38>
  if (table[slot].stack)
 c86:	89 d8                	mov    %ebx,%eax
 c88:	c1 e0 04             	shl    $0x4,%eax
 c8b:	8b 80 c8 16 00 00    	mov    0x16c8(%eax),%eax
 c91:	85 c0                	test   %eax,%eax
 c93:	74 0c                	je     ca1 <thread_join+0x61>
    free(table[slot].stack);
 c95:	83 ec 0c             	sub    $0xc,%esp
 c98:	50                   	push   %eax
 c99:	e8 22 fc ff ff       	call   8c0 <free>
 c9e:	83 c4 10             	add    $0x10,%esp
  table[slot].state = FREE;
 ca1:	c1 e3 04             	shl    $0x4,%ebx
  return 0;
 ca4:	31 c0                	xor    %eax,%eax
  table[slot].state = FREE;
 ca6:	c7 83 c0 16 00 00 00 	movl   $0x0,0x16c0(%ebx)
 cad:	00 00 00 
  table[slot].stack = 0;
 cb0:	c7 83 c8 16 00 00 00 	movl   $0x0,0x16c8(%ebx)
 cb7:	00 00 00 
  table[slot].ctx   = 0;
 cba:	c7 83 cc 16 00 00 00 	movl   $0x0,0x16cc(%ebx)
 cc1:	00 00 00 
...
void mutex_lock(umutex_t *m){ while(m->locked){ thread_yield(); } m->locked = 1; }
 ...
 cea:	8b 03                	mov    (%ebx),%eax
 cec:	85 c0                	test   %eax,%eax
 cee:	74 0b                	je     cfb <mutex_lock+0x1b>
 cf0:	e8 7b fe ff ff       	call   b70 <thread_yield>
