...
00000060 <fmtname>:
{
  ...
  db:	05 c0 11 00 00       	add    $0x11c0,%eax
  e0:	52                   	push   %edx
  e1:	6a 20                	push   $0x20
  e3:	50                   	push   %eax
 ...
 628:	89 d1                	mov    %edx,%ecx
{
 ...
 65b:	0f b6 92 70 0d 00 00 	movzbl 0xd70(%edx),%edx
 ...
 6c9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 734:	ff 24 85 18 0d 00 00 	jmp    *0xd18(,%eax,4)
 ...
 840:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 845:	bb 0e 0d 00 00       	mov    $0xd0e,%ebx
...
free(void *ap)
{
 ...
 851:	a1 d0 11 00 00       	mov    0x11d0,%eax
{
 ...
 88f:	5b                   	pop    %ebx
  freep = p;
 890:	a3 d0 11 00 00       	mov    %eax,0x11d0
}
 895:	5e                   	pop    %esi
 896:	5f                   	pop    %edi
 897:	5d                   	pop    %ebp
 ...
 8a6:	72 ce                	jb     876 <free+0x26>
{
 ...
 8c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 8ca:	a3 d0 11 00 00       	mov    %eax,0x11d0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 8e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8ec:	8b 15 d0 11 00 00    	mov    0x11d0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 92b:	3b 05 d0 11 00 00    	cmp    0x11d0,%eax
 ...
 94e:	e8 fd fe ff ff       	call   850 <free>
  return freep;
 953:	8b 15 d0 11 00 00    	mov    0x11d0,%edx
 ...
 97c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 97f:	89 15 d0 11 00 00    	mov    %edx,0x11d0
}
 ...
 98f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 990:	c7 05 d0 11 00 00 d4 	movl   $0x11d4,0x11d0
 997:	11 00 00 
    base.s.size = 0;
 99a:	b8 d4 11 00 00       	mov    $0x11d4,%eax
    base.s.ptr = freep = prevp = &base;
 99f:	c7 05 d4 11 00 00 d4 	movl   $0x11d4,0x11d4
 9a6:	11 00 00 
    base.s.size = 0;
 9a9:	c7 05 d8 11 00 00 00 	movl   $0x0,0x11d8
 9b0:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 9d0:	b8 00 12 00 00       	mov    $0x1200,%eax
 9d5:	8d 76 00             	lea    0x0(%esi),%esi
    table[i].state = FREE;
 9d8:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 9de:	83 c0 20             	add    $0x20,%eax
    table[i].state = FREE;
 9e1:	c7 40 f0 00 00 00 00 	movl   $0x0,-0x10(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 9e8:	3d 00 13 00 00       	cmp    $0x1300,%eax
 9ed:	75 e9                	jne    9d8 <thread_init+0x8>
 
  table[0].state = RUNNING;
  table[0].tid   = next_tid++;
 9ef:	a1 b8 11 00 00       	mov    0x11b8,%eax
  table[0].state = RUNNING;
 9f4:	c7 05 00 12 00 00 02 	movl   $0x2,0x1200
 9fb:	00 00 00 
  table[0].stack = 0;   
 9fe:	c7 05 08 12 00 00 00 	movl   $0x0,0x1208
 a05:	00 00 00 
  table[0].tid   = next_tid++;
 a08:	8d 50 01             	lea    0x1(%eax),%edx
 a0b:	a3 04 12 00 00       	mov    %eax,0x1204
 a10:	89 15 b8 11 00 00    	mov    %edx,0x11b8
  table[0].ctx   = &main_ctx;
 a16:	c7 05 0c 12 00 00 e0 	movl   $0x11e0,0x120c
 a1d:	11 00 00 
  current = 0;
 a20:	c7 05 f4 11 00 00 00 	movl   $0x0,0x11f4
 a27:	00 00 00 
}
 a2a:	c3                   	ret
 a2b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 a42:	c1 e3 04             	shl    $0x4,%ebx
 a45:	8b 93 00 12 00 00    	mov    0x1200(%ebx),%edx
 a4b:	85 d2                	test   %edx,%edx
 a4d:	74 19                	je     a68 <thread_create+0x38>
  for (int i = 1; i < MAX_THREADS; i++) {
 a4f:	83 c0 01             	add    $0x1,%eax
 a52:	83 f8 10             	cmp    $0x10,%eax
 a55:	75 e9                	jne    a40 <thread_create+0x10>
  }
  if (slot == -1) return -1;
 a57:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 a5c:	e9 98 00 00 00       	jmp    af9 <thread_create+0xc9>
 a61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 
  char *stk = malloc(STACK_SIZE);
 a68:	83 ec 0c             	sub    $0xc,%esp
 a6b:	68 00 20 00 00       	push   $0x2000
 a70:	e8 6b fe ff ff       	call   8e0 <malloc>
  if (!stk) return -1;
 a75:	83 c4 10             	add    $0x10,%esp
  char *stk = malloc(STACK_SIZE);
 a78:	89 c6                	mov    %eax,%esi
  if (!stk) return -1;
 a7a:	85 c0                	test   %eax,%eax
 a7c:	74 d9                	je     a57 <thread_create+0x27>
  memset(stk, 0, STACK_SIZE);
 a7e:	83 ec 04             	sub    $0x4,%esp
 a81:	68 00 20 00 00       	push   $0x2000
 a86:	6a 00                	push   $0x0
 a88:	56                   	push   %esi
 a89:	e8 62 f9 ff ff       	call   3f0 <memset>
 ...
 a91:	89 b3 08 12 00 00    	mov    %esi,0x1208(%ebx)
  table[slot].ctx   = (struct context*)sp;

  return table[slot].tid;
 a97:	83 c4 10             	add    $0x10,%esp
  sp--;  *sp = 0xffffffff;
 a9a:	c7 86 f4 1f 00 00 ff 	movl   $0xffffffff,0x1ff4(%esi)
 aa1:	ff ff ff 
  sp--;  *sp = 0;   /* edi */
 aa4:	81 c6 e0 1f 00 00    	add    $0x1fe0,%esi
  sp--;  *sp = (uint)arg;
 aaa:	89 46 1c             	mov    %eax,0x1c(%esi)
  sp--;  *sp = (uint)fn;
 aad:	8b 45 08             	mov    0x8(%ebp),%eax
  sp--;  *sp = (uint)thread_stub;
 ab0:	c7 46 10 a0 0b 00 00 	movl   $0xba0,0x10(%esi)
  sp--;  *sp = (uint)fn;
 ab7:	89 46 18             	mov    %eax,0x18(%esi)
  table[slot].tid   = next_tid++;
 aba:	a1 b8 11 00 00       	mov    0x11b8,%eax
  sp--;  *sp = 0;   /* ebp */
 abf:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
  table[slot].tid   = next_tid++;
 ac6:	8d 48 01             	lea    0x1(%eax),%ecx
  sp--;  *sp = 0;   /* ebx */
 ac9:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)
  sp--;  *sp = 0;   /* esi */
 ad0:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
  sp--;  *sp = 0;   /* edi */
 ad7:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  table[slot].state = RUNNABLE;
 add:	c7 83 00 12 00 00 01 	movl   $0x1,0x1200(%ebx)
 ae4:	00 00 00 
  table[slot].tid   = next_tid++;
 ae7:	89 0d b8 11 00 00    	mov    %ecx,0x11b8
 aed:	89 83 04 12 00 00    	mov    %eax,0x1204(%ebx)
  sp--;  *sp = 0;   /* edi */
 af3:	89 b3 0c 12 00 00    	mov    %esi,0x120c(%ebx)
}
 af9:	8d 65 f8             	lea    -0x8(%ebp),%esp
 afc:	5b                   	pop    %ebx
 afd:	5e                   	pop    %esi
 afe:	5d                   	pop    %ebp
 aff:	c3                   	ret
...
void thread_yield(void) {
 ...
 b05:	8b 35 f4 11 00 00    	mov    0x11f4,%esi
 b0b:	8d 4e 01             	lea    0x1(%esi),%ecx
 b0e:	8d 5e 11             	lea    0x11(%esi),%ebx
 b11:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 b18:	89 ca                	mov    %ecx,%edx
 b1a:	c1 fa 1f             	sar    $0x1f,%edx
 b1d:	c1 ea 1c             	shr    $0x1c,%edx
 b20:	8d 04 11             	lea    (%ecx,%edx,1),%eax
 b23:	83 e0 0f             	and    $0xf,%eax
 b26:	29 d0                	sub    %edx,%eax
    if (table[idx].state == RUNNABLE)
 b28:	89 c2                	mov    %eax,%edx
 b2a:	c1 e2 04             	shl    $0x4,%edx
 b2d:	83 ba 00 12 00 00 01 	cmpl   $0x1,0x1200(%edx)
 b34:	74 12                	je     b48 <thread_yield+0x48>
  for (int i = 1; i <= MAX_THREADS; i++) {
 b36:	83 c1 01             	add    $0x1,%ecx
 b39:	39 d9                	cmp    %ebx,%ecx
 b3b:	75 db                	jne    b18 <thread_yield+0x18>
 ...
 b4b:	74 f0                	je     b3d <thread_yield+0x3d>
  if (table[prev].state == RUNNING)
 b4d:	89 f2                	mov    %esi,%edx
 b4f:	c1 e2 04             	shl    $0x4,%edx
 b52:	83 ba 00 12 00 00 02 	cmpl   $0x2,0x1200(%edx)
 b59:	75 0a                	jne    b65 <thread_yield+0x65>
    table[prev].state = RUNNABLE;
 b5b:	c7 82 00 12 00 00 01 	movl   $0x1,0x1200(%edx)
 b62:	00 00 00 
  table[next].state = RUNNING;
 b65:	89 c2                	mov    %eax,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 b67:	c1 e6 04             	shl    $0x4,%esi
 b6a:	83 ec 08             	sub    $0x8,%esp
  current = next;
 b6d:	a3 f4 11 00 00       	mov    %eax,0x11f4
  table[next].state = RUNNING;
 b72:	c1 e2 04             	shl    $0x4,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 b75:	81 c6 0c 12 00 00    	add    $0x120c,%esi
  table[next].state = RUNNING;
 b7b:	c7 82 00 12 00 00 02 	movl   $0x2,0x1200(%edx)
 b82:	00 00 00 
  uswtch(&table[prev].ctx, table[next].ctx);
 b85:	ff b2 0c 12 00 00    	push   0x120c(%edx)
 b8b:	56                   	push   %esi
 b8c:	e8 1d 01 00 00       	call   cae <uswtch>
 b91:	83 c4 10             	add    $0x10,%esp
}
 b94:	8d 65 f8             	lea    -0x8(%ebp),%esp
 b97:	5b                   	pop    %ebx
 b98:	5e                   	pop    %esi
 b99:	5d                   	pop    %ebp
 b9a:	c3                   	ret
 b9b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi

00000ba0 <thread_stub>:
static void thread_stub(void (*fn)(void*), void *arg) {
 ba0:	55                   	push   %ebp
 ba1:	89 e5                	mov    %esp,%ebp
 ba3:	83 ec 14             	sub    $0x14,%esp
  fn(arg);
 ba6:	ff 75 0c             	push   0xc(%ebp)
 ba9:	ff 55 08             	call   *0x8(%ebp)
  table[current].state = ZOMBIE;
 bac:	a1 f4 11 00 00       	mov    0x11f4,%eax
 bb1:	c1 e0 04             	shl    $0x4,%eax
 bb4:	c7 80 00 12 00 00 03 	movl   $0x3,0x1200(%eax)
 bbb:	00 00 00 
  thread_yield();
 bbe:	e8 3d ff ff ff       	call   b00 <thread_yield>
  exit();
 bc3:	e8 ab f9 ff ff       	call   573 <exit>
 bc8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 bcf:	00 
...
int thread_join(tid_t tid) {
 ...
 be0:	89 de                	mov    %ebx,%esi
 be2:	c1 e6 04             	shl    $0x4,%esi
 be5:	39 86 04 12 00 00    	cmp    %eax,0x1204(%esi)
 beb:	74 20                	je     c0d <thread_join+0x3d>
  for (int i = 0; i < MAX_THREADS; i++) {
 bed:	83 c3 01             	add    $0x1,%ebx
 bf0:	83 fb 10             	cmp    $0x10,%ebx
 bf3:	75 eb                	jne    be0 <thread_join+0x10>
  table[slot].state = FREE;
  table[slot].stack = 0;
  table[slot].ctx   = 0;
 
  return 0;
 bf5:	8d 65 f8             	lea    -0x8(%ebp),%esp
  if (slot == -1) return -1;
 ...
 c0d:	83 be 00 12 00 00 03 	cmpl   $0x3,0x1200(%esi)
 c14:	75 f2                	jne    c08 <thread_join+0x38>
  if (table[slot].stack)
 c16:	89 d8                	mov    %ebx,%eax
 c18:	c1 e0 04             	shl    $0x4,%eax
 c1b:	8b 80 08 12 00 00    	mov    0x1208(%eax),%eax
 c21:	85 c0                	test   %eax,%eax
 c23:	74 0c                	je     c31 <thread_join+0x61>
    free(table[slot].stack);
 c25:	83 ec 0c             	sub    $0xc,%esp
 c28:	50                   	push   %eax
 c29:	e8 22 fc ff ff       	call   850 <free>
 c2e:	83 c4 10             	add    $0x10,%esp
  table[slot].state = FREE;
 c31:	c1 e3 04             	shl    $0x4,%ebx
  return 0;
 c34:	31 c0                	xor    %eax,%eax
  table[slot].state = FREE;
 c36:	c7 83 00 12 00 00 00 	movl   $0x0,0x1200(%ebx)
 c3d:	00 00 00 
  table[slot].stack = 0;
 c40:	c7 83 08 12 00 00 00 	movl   $0x0,0x1208(%ebx)
 c47:	00 00 00 
  table[slot].ctx   = 0;
 c4a:	c7 83 0c 12 00 00 00 	movl   $0x0,0x120c(%ebx)
 c51:	00 00 00 
...
void mutex_lock(umutex_t *m){ while(m->locked){ thread_yield(); } m->locked = 1; }
 ...
 c7a:	8b 03                	mov    (%ebx),%eax
 c7c:	85 c0                	test   %eax,%eax
 c7e:	74 0b                	je     c8b <mutex_lock+0x1b>
 c80:	e8 7b fe ff ff       	call   b00 <thread_yield>
 c85:	8b 03                	mov    (%ebx),%eax
 c87:	85 c0                	test   %eax,%eax
 c89:	75 f5                	jne    c80 <mutex_lock+0x10>
 c8b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
...
uswtch:
  movl 4(%esp), %eax
 cae:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
 cb2:	8b 54 24 08          	mov    0x8(%esp),%edx
 ...
 cb9:	57                   	push   %edi
  ...
  movl %esp, (%eax)
 cba:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
 cbc:	89 d4                	mov    %edx,%esp
