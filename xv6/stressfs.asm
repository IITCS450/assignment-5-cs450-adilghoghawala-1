 ...
 418:	89 d1                	mov    %edx,%ecx
{
 ...
 44b:	0f b6 92 38 0b 00 00 	movzbl 0xb38(%edx),%edx
 ...
 4b9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 524:	ff 24 85 e0 0a 00 00 	jmp    *0xae0(,%eax,4)
 ...
 630:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 635:	bb d7 0a 00 00       	mov    $0xad7,%ebx
...
free(void *ap)
{
 ...
 641:	a1 20 0f 00 00       	mov    0xf20,%eax
{
 ...
 67f:	5b                   	pop    %ebx
  freep = p;
 680:	a3 20 0f 00 00       	mov    %eax,0xf20
}
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
 687:	5d                   	pop    %ebp
 ...
 696:	72 ce                	jb     666 <free+0x26>
{
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 20 0f 00 00       	mov    %eax,0xf20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 20 0f 00 00    	mov    0xf20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71b:	3b 05 20 0f 00 00    	cmp    0xf20,%eax
 ...
 73e:	e8 fd fe ff ff       	call   640 <free>
  return freep;
 743:	8b 15 20 0f 00 00    	mov    0xf20,%edx
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 76f:	89 15 20 0f 00 00    	mov    %edx,0xf20
}
 ...
 77f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 20 0f 00 00 24 	movl   $0xf24,0xf20
 787:	0f 00 00 
    base.s.size = 0;
 78a:	b8 24 0f 00 00       	mov    $0xf24,%eax
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 24 0f 00 00 24 	movl   $0xf24,0xf24
 796:	0f 00 00 
    base.s.size = 0;
 799:	c7 05 28 0f 00 00 00 	movl   $0x0,0xf28
 7a0:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 7c0:	b8 60 0f 00 00       	mov    $0xf60,%eax
 7c5:	8d 76 00             	lea    0x0(%esi),%esi
    table[i].state = FREE;
 7c8:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 7ce:	83 c0 20             	add    $0x20,%eax
    table[i].state = FREE;
 7d1:	c7 40 f0 00 00 00 00 	movl   $0x0,-0x10(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 7d8:	3d 60 10 00 00       	cmp    $0x1060,%eax
 7dd:	75 e9                	jne    7c8 <thread_init+0x8>
 
  table[0].state = RUNNING;
  table[0].tid   = next_tid++;
 7df:	a1 08 0f 00 00       	mov    0xf08,%eax
  table[0].state = RUNNING;
 7e4:	c7 05 60 0f 00 00 02 	movl   $0x2,0xf60
 7eb:	00 00 00 
  table[0].stack = 0;   
 7ee:	c7 05 68 0f 00 00 00 	movl   $0x0,0xf68
 7f5:	00 00 00 
  table[0].tid   = next_tid++;
 7f8:	8d 50 01             	lea    0x1(%eax),%edx
 7fb:	a3 64 0f 00 00       	mov    %eax,0xf64
 800:	89 15 08 0f 00 00    	mov    %edx,0xf08
  table[0].ctx   = &main_ctx;
 806:	c7 05 6c 0f 00 00 40 	movl   $0xf40,0xf6c
 80d:	0f 00 00 
  current = 0;
 810:	c7 05 54 0f 00 00 00 	movl   $0x0,0xf54
 817:	00 00 00 
}
 81a:	c3                   	ret
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 821:	b8 01 00 00 00       	mov    $0x1,%eax
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 832:	c1 e3 04             	shl    $0x4,%ebx
 835:	8b 93 60 0f 00 00    	mov    0xf60(%ebx),%edx
 83b:	85 d2                	test   %edx,%edx
 83d:	74 19                	je     858 <thread_create+0x38>
  for (int i = 1; i < MAX_THREADS; i++) {
 83f:	83 c0 01             	add    $0x1,%eax
 842:	83 f8 10             	cmp    $0x10,%eax
 845:	75 e9                	jne    830 <thread_create+0x10>
  }
  if (slot == -1) return -1;
 847:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 84c:	e9 98 00 00 00       	jmp    8e9 <thread_create+0xc9>
 851:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 
  char *stk = malloc(STACK_SIZE);
 858:	83 ec 0c             	sub    $0xc,%esp
 85b:	68 00 20 00 00       	push   $0x2000
 860:	e8 6b fe ff ff       	call   6d0 <malloc>
  if (!stk) return -1;
 ...
 86c:	74 d9                	je     847 <thread_create+0x27>
  memset(stk, 0, STACK_SIZE);
 86e:	83 ec 04             	sub    $0x4,%esp
 871:	68 00 20 00 00       	push   $0x2000
 876:	6a 00                	push   $0x0
 878:	56                   	push   %esi
 879:	e8 62 f9 ff ff       	call   1e0 <memset>
 ...
 881:	89 b3 68 0f 00 00    	mov    %esi,0xf68(%ebx)
  table[slot].ctx   = (struct context*)sp;

  return table[slot].tid;
 887:	83 c4 10             	add    $0x10,%esp
  sp--;  *sp = 0xffffffff;
 88a:	c7 86 f4 1f 00 00 ff 	movl   $0xffffffff,0x1ff4(%esi)
 891:	ff ff ff 
  sp--;  *sp = 0;   /* edi */
 894:	81 c6 e0 1f 00 00    	add    $0x1fe0,%esi
  sp--;  *sp = (uint)arg;
 89a:	89 46 1c             	mov    %eax,0x1c(%esi)
  sp--;  *sp = (uint)fn;
 89d:	8b 45 08             	mov    0x8(%ebp),%eax
  sp--;  *sp = (uint)thread_stub;
 8a0:	c7 46 10 90 09 00 00 	movl   $0x990,0x10(%esi)
  sp--;  *sp = (uint)fn;
 8a7:	89 46 18             	mov    %eax,0x18(%esi)
  table[slot].tid   = next_tid++;
 8aa:	a1 08 0f 00 00       	mov    0xf08,%eax
  sp--;  *sp = 0;   /* ebp */
 8af:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
  table[slot].tid   = next_tid++;
 8b6:	8d 48 01             	lea    0x1(%eax),%ecx
  sp--;  *sp = 0;   /* ebx */
 8b9:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)
  sp--;  *sp = 0;   /* esi */
 8c0:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
  sp--;  *sp = 0;   /* edi */
 8c7:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  table[slot].state = RUNNABLE;
 8cd:	c7 83 60 0f 00 00 01 	movl   $0x1,0xf60(%ebx)
 8d4:	00 00 00 
  table[slot].tid   = next_tid++;
 8d7:	89 0d 08 0f 00 00    	mov    %ecx,0xf08
 8dd:	89 83 64 0f 00 00    	mov    %eax,0xf64(%ebx)
  sp--;  *sp = 0;   /* edi */
 8e3:	89 b3 6c 0f 00 00    	mov    %esi,0xf6c(%ebx)
}
...
void thread_yield(void) {
 ...
 8f5:	8b 35 54 0f 00 00    	mov    0xf54,%esi
 8fb:	8d 4e 01             	lea    0x1(%esi),%ecx
 8fe:	8d 5e 11             	lea    0x11(%esi),%ebx
 901:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 908:	89 ca                	mov    %ecx,%edx
 90a:	c1 fa 1f             	sar    $0x1f,%edx
 90d:	c1 ea 1c             	shr    $0x1c,%edx
 910:	8d 04 11             	lea    (%ecx,%edx,1),%eax
 913:	83 e0 0f             	and    $0xf,%eax
 916:	29 d0                	sub    %edx,%eax
    if (table[idx].state == RUNNABLE)
 918:	89 c2                	mov    %eax,%edx
 91a:	c1 e2 04             	shl    $0x4,%edx
 91d:	83 ba 60 0f 00 00 01 	cmpl   $0x1,0xf60(%edx)
 924:	74 12                	je     938 <thread_yield+0x48>
  for (int i = 1; i <= MAX_THREADS; i++) {
 926:	83 c1 01             	add    $0x1,%ecx
 929:	39 d9                	cmp    %ebx,%ecx
 92b:	75 db                	jne    908 <thread_yield+0x18>
 ...
 93b:	74 f0                	je     92d <thread_yield+0x3d>
  if (table[prev].state == RUNNING)
 93d:	89 f2                	mov    %esi,%edx
 93f:	c1 e2 04             	shl    $0x4,%edx
 942:	83 ba 60 0f 00 00 02 	cmpl   $0x2,0xf60(%edx)
 949:	75 0a                	jne    955 <thread_yield+0x65>
    table[prev].state = RUNNABLE;
 94b:	c7 82 60 0f 00 00 01 	movl   $0x1,0xf60(%edx)
 952:	00 00 00 
  table[next].state = RUNNING;
 955:	89 c2                	mov    %eax,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 957:	c1 e6 04             	shl    $0x4,%esi
 95a:	83 ec 08             	sub    $0x8,%esp
  current = next;
 95d:	a3 54 0f 00 00       	mov    %eax,0xf54
  table[next].state = RUNNING;
 962:	c1 e2 04             	shl    $0x4,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 965:	81 c6 6c 0f 00 00    	add    $0xf6c,%esi
  table[next].state = RUNNING;
 96b:	c7 82 60 0f 00 00 02 	movl   $0x2,0xf60(%edx)
 972:	00 00 00 
  uswtch(&table[prev].ctx, table[next].ctx);
 975:	ff b2 6c 0f 00 00    	push   0xf6c(%edx)
 97b:	56                   	push   %esi
 97c:	e8 1d 01 00 00       	call   a9e <uswtch>
...
static void thread_stub(void (*fn)(void*), void *arg) {
 ...
 99c:	a1 54 0f 00 00       	mov    0xf54,%eax
 9a1:	c1 e0 04             	shl    $0x4,%eax
 9a4:	c7 80 60 0f 00 00 03 	movl   $0x3,0xf60(%eax)
 9ab:	00 00 00 
  thread_yield();
 9ae:	e8 3d ff ff ff       	call   8f0 <thread_yield>
  exit();
 9b3:	e8 ab f9 ff ff       	call   363 <exit>
...
int thread_join(tid_t tid) {
 ...
 9d0:	89 de                	mov    %ebx,%esi
 9d2:	c1 e6 04             	shl    $0x4,%esi
 9d5:	39 86 64 0f 00 00    	cmp    %eax,0xf64(%esi)
 9db:	74 20                	je     9fd <thread_join+0x3d>
  for (int i = 0; i < MAX_THREADS; i++) {
 9dd:	83 c3 01             	add    $0x1,%ebx
 9e0:	83 fb 10             	cmp    $0x10,%ebx
 9e3:	75 eb                	jne    9d0 <thread_join+0x10>
 ...
 9fd:	83 be 60 0f 00 00 03 	cmpl   $0x3,0xf60(%esi)
 a04:	75 f2                	jne    9f8 <thread_join+0x38>
  if (table[slot].stack)
 a06:	89 d8                	mov    %ebx,%eax
 a08:	c1 e0 04             	shl    $0x4,%eax
 a0b:	8b 80 68 0f 00 00    	mov    0xf68(%eax),%eax
 a11:	85 c0                	test   %eax,%eax
 a13:	74 0c                	je     a21 <thread_join+0x61>
    free(table[slot].stack);
 a15:	83 ec 0c             	sub    $0xc,%esp
 a18:	50                   	push   %eax
 a19:	e8 22 fc ff ff       	call   640 <free>
 a1e:	83 c4 10             	add    $0x10,%esp
  table[slot].state = FREE;
 a21:	c1 e3 04             	shl    $0x4,%ebx
  return 0;
 a24:	31 c0                	xor    %eax,%eax
  table[slot].state = FREE;
 a26:	c7 83 60 0f 00 00 00 	movl   $0x0,0xf60(%ebx)
 a2d:	00 00 00 
  table[slot].stack = 0;
 a30:	c7 83 68 0f 00 00 00 	movl   $0x0,0xf68(%ebx)
 a37:	00 00 00 
  table[slot].ctx   = 0;
 a3a:	c7 83 6c 0f 00 00 00 	movl   $0x0,0xf6c(%ebx)
 a41:	00 00 00 
...
void mutex_lock(umutex_t *m){ while(m->locked){ thread_yield(); } m->locked = 1; }
 ...
 a6a:	8b 03                	mov    (%ebx),%eax
 a6c:	85 c0                	test   %eax,%eax
 a6e:	74 0b                	je     a7b <mutex_lock+0x1b>
 a70:	e8 7b fe ff ff       	call   8f0 <thread_yield>
