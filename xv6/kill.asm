 ...
 358:	89 d1                	mov    %edx,%ecx
{
 ...
 38b:	0f b6 92 68 0a 00 00 	movzbl 0xa68(%edx),%edx
 ...
 3f9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 464:	ff 24 85 10 0a 00 00 	jmp    *0xa10(,%eax,4)
 ...
 570:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 575:	bb 08 0a 00 00       	mov    $0xa08,%ebx
 ...
 581:	a1 40 0e 00 00       	mov    0xe40,%eax
{
 ...
 5bf:	5b                   	pop    %ebx
  freep = p;
 5c0:	a3 40 0e 00 00       	mov    %eax,0xe40
}
 5c5:	5e                   	pop    %esi
 5c6:	5f                   	pop    %edi
 5c7:	5d                   	pop    %ebp
 ...
 5d6:	72 ce                	jb     5a6 <free+0x26>
{
 ...
 5f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5fa:	a3 40 0e 00 00       	mov    %eax,0xe40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 40 0e 00 00    	mov    0xe40,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 65b:	3b 05 40 0e 00 00    	cmp    0xe40,%eax
 ...
 67e:	e8 fd fe ff ff       	call   580 <free>
  return freep;
 683:	8b 15 40 0e 00 00    	mov    0xe40,%edx
 ...
 6ac:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6af:	89 15 40 0e 00 00    	mov    %edx,0xe40
}
 ...
 6bf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6c0:	c7 05 40 0e 00 00 44 	movl   $0xe44,0xe40
 6c7:	0e 00 00 
    base.s.size = 0;
 6ca:	b8 44 0e 00 00       	mov    $0xe44,%eax
    base.s.ptr = freep = prevp = &base;
 6cf:	c7 05 44 0e 00 00 44 	movl   $0xe44,0xe44
 6d6:	0e 00 00 
    base.s.size = 0;
 6d9:	c7 05 48 0e 00 00 00 	movl   $0x0,0xe48
 6e0:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 700:	b8 80 0e 00 00       	mov    $0xe80,%eax
 ...
 711:	c7 40 f0 00 00 00 00 	movl   $0x0,-0x10(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 718:	3d 80 0f 00 00       	cmp    $0xf80,%eax
 71d:	75 e9                	jne    708 <thread_init+0x8>
 
  table[0].state = RUNNING;
  table[0].tid   = next_tid++;
 71f:	a1 38 0e 00 00       	mov    0xe38,%eax
  table[0].state = RUNNING;
 724:	c7 05 80 0e 00 00 02 	movl   $0x2,0xe80
 72b:	00 00 00 
  table[0].stack = 0;   
 72e:	c7 05 88 0e 00 00 00 	movl   $0x0,0xe88
 735:	00 00 00 
  table[0].tid   = next_tid++;
 738:	8d 50 01             	lea    0x1(%eax),%edx
 73b:	a3 84 0e 00 00       	mov    %eax,0xe84
 740:	89 15 38 0e 00 00    	mov    %edx,0xe38
  table[0].ctx   = &main_ctx;
 746:	c7 05 8c 0e 00 00 60 	movl   $0xe60,0xe8c
 74d:	0e 00 00 
  current = 0;
 750:	c7 05 74 0e 00 00 00 	movl   $0x0,0xe74
 757:	00 00 00 
}
 75a:	c3                   	ret
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 775:	8b 93 80 0e 00 00    	mov    0xe80(%ebx),%edx
 ...
 7c1:	89 b3 88 0e 00 00    	mov    %esi,0xe88(%ebx)
 ...
 7e7:	89 46 18             	mov    %eax,0x18(%esi)
  table[slot].tid   = next_tid++;
 7ea:	a1 38 0e 00 00       	mov    0xe38,%eax
  sp--;  *sp = 0;   /* ebp */
 ...
 807:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  table[slot].state = RUNNABLE;
 80d:	c7 83 80 0e 00 00 01 	movl   $0x1,0xe80(%ebx)
 814:	00 00 00 
  table[slot].tid   = next_tid++;
 817:	89 0d 38 0e 00 00    	mov    %ecx,0xe38
 81d:	89 83 84 0e 00 00    	mov    %eax,0xe84(%ebx)
  sp--;  *sp = 0;   /* edi */
 823:	89 b3 8c 0e 00 00    	mov    %esi,0xe8c(%ebx)
}
...
void thread_yield(void) {
 ...
 835:	8b 35 74 0e 00 00    	mov    0xe74,%esi
 ...
 85d:	83 ba 80 0e 00 00 01 	cmpl   $0x1,0xe80(%edx)
 ...
 882:	83 ba 80 0e 00 00 02 	cmpl   $0x2,0xe80(%edx)
 889:	75 0a                	jne    895 <thread_yield+0x65>
    table[prev].state = RUNNABLE;
 88b:	c7 82 80 0e 00 00 01 	movl   $0x1,0xe80(%edx)
 892:	00 00 00 
  table[next].state = RUNNING;
 ...
 89a:	83 ec 08             	sub    $0x8,%esp
  current = next;
 89d:	a3 74 0e 00 00       	mov    %eax,0xe74
  table[next].state = RUNNING;
 8a2:	c1 e2 04             	shl    $0x4,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 8a5:	81 c6 8c 0e 00 00    	add    $0xe8c,%esi
  table[next].state = RUNNING;
 8ab:	c7 82 80 0e 00 00 02 	movl   $0x2,0xe80(%edx)
 8b2:	00 00 00 
  uswtch(&table[prev].ctx, table[next].ctx);
 8b5:	ff b2 8c 0e 00 00    	push   0xe8c(%edx)
 8bb:	56                   	push   %esi
...
static void thread_stub(void (*fn)(void*), void *arg) {
 ...
 8dc:	a1 74 0e 00 00       	mov    0xe74,%eax
 8e1:	c1 e0 04             	shl    $0x4,%eax
 8e4:	c7 80 80 0e 00 00 03 	movl   $0x3,0xe80(%eax)
 8eb:	00 00 00 
  thread_yield();
...
int thread_join(tid_t tid) {
 ...
 915:	39 86 84 0e 00 00    	cmp    %eax,0xe84(%esi)
 ...
 93d:	83 be 80 0e 00 00 03 	cmpl   $0x3,0xe80(%esi)
 944:	75 f2                	jne    938 <thread_join+0x38>
  if (table[slot].stack)
 946:	89 d8                	mov    %ebx,%eax
 948:	c1 e0 04             	shl    $0x4,%eax
 94b:	8b 80 88 0e 00 00    	mov    0xe88(%eax),%eax
 ...
 964:	31 c0                	xor    %eax,%eax
  table[slot].state = FREE;
 966:	c7 83 80 0e 00 00 00 	movl   $0x0,0xe80(%ebx)
 96d:	00 00 00 
  table[slot].stack = 0;
 970:	c7 83 88 0e 00 00 00 	movl   $0x0,0xe88(%ebx)
 977:	00 00 00 
  table[slot].ctx   = 0;
 97a:	c7 83 8c 0e 00 00 00 	movl   $0x0,0xe8c(%ebx)
 981:	00 00 00 
