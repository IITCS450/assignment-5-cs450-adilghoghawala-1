 ...
 358:	89 d1                	mov    %edx,%ecx
{
 ...
 38b:	0f b6 92 7c 0a 00 00 	movzbl 0xa7c(%edx),%edx
 ...
 3f9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 464:	ff 24 85 24 0a 00 00 	jmp    *0xa24(,%eax,4)
 ...
 570:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 575:	bb 1b 0a 00 00       	mov    $0xa1b,%ebx
...
free(void *ap)
{
 ...
 581:	a1 60 0e 00 00       	mov    0xe60,%eax
{
 ...
 5bf:	5b                   	pop    %ebx
  freep = p;
 5c0:	a3 60 0e 00 00       	mov    %eax,0xe60
}
 5c5:	5e                   	pop    %esi
 5c6:	5f                   	pop    %edi
 5c7:	5d                   	pop    %ebp
 ...
 5d6:	72 ce                	jb     5a6 <free+0x26>
{
 ...
 5f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5fa:	a3 60 0e 00 00       	mov    %eax,0xe60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 60 0e 00 00    	mov    0xe60,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 65b:	3b 05 60 0e 00 00    	cmp    0xe60,%eax
 ...
 67e:	e8 fd fe ff ff       	call   580 <free>
  return freep;
 683:	8b 15 60 0e 00 00    	mov    0xe60,%edx
 ...
 6ac:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6af:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 ...
 6bf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6c0:	c7 05 60 0e 00 00 64 	movl   $0xe64,0xe60
 6c7:	0e 00 00 
    base.s.size = 0;
 6ca:	b8 64 0e 00 00       	mov    $0xe64,%eax
    base.s.ptr = freep = prevp = &base;
 6cf:	c7 05 64 0e 00 00 64 	movl   $0xe64,0xe64
 6d6:	0e 00 00 
    base.s.size = 0;
 6d9:	c7 05 68 0e 00 00 00 	movl   $0x0,0xe68
 6e0:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 700:	b8 a0 0e 00 00       	mov    $0xea0,%eax
 705:	8d 76 00             	lea    0x0(%esi),%esi
    table[i].state = FREE;
 708:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 70e:	83 c0 20             	add    $0x20,%eax
    table[i].state = FREE;
 711:	c7 40 f0 00 00 00 00 	movl   $0x0,-0x10(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 718:	3d a0 0f 00 00       	cmp    $0xfa0,%eax
 71d:	75 e9                	jne    708 <thread_init+0x8>
 
  table[0].state = RUNNING;
  table[0].tid   = next_tid++;
 71f:	a1 40 0e 00 00       	mov    0xe40,%eax
  table[0].state = RUNNING;
 724:	c7 05 a0 0e 00 00 02 	movl   $0x2,0xea0
 72b:	00 00 00 
  table[0].stack = 0;   
 72e:	c7 05 a8 0e 00 00 00 	movl   $0x0,0xea8
 735:	00 00 00 
  table[0].tid   = next_tid++;
 738:	8d 50 01             	lea    0x1(%eax),%edx
 73b:	a3 a4 0e 00 00       	mov    %eax,0xea4
 740:	89 15 40 0e 00 00    	mov    %edx,0xe40
  table[0].ctx   = &main_ctx;
 746:	c7 05 ac 0e 00 00 80 	movl   $0xe80,0xeac
 74d:	0e 00 00 
  current = 0;
 750:	c7 05 94 0e 00 00 00 	movl   $0x0,0xe94
 757:	00 00 00 
}
 75a:	c3                   	ret
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 772:	c1 e3 04             	shl    $0x4,%ebx
 775:	8b 93 a0 0e 00 00    	mov    0xea0(%ebx),%edx
 77b:	85 d2                	test   %edx,%edx
 77d:	74 19                	je     798 <thread_create+0x38>
  for (int i = 1; i < MAX_THREADS; i++) {
 77f:	83 c0 01             	add    $0x1,%eax
 782:	83 f8 10             	cmp    $0x10,%eax
 785:	75 e9                	jne    770 <thread_create+0x10>
  }
  if (slot == -1) return -1;
 787:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 78c:	e9 98 00 00 00       	jmp    829 <thread_create+0xc9>
 791:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 
  char *stk = malloc(STACK_SIZE);
 798:	83 ec 0c             	sub    $0xc,%esp
 79b:	68 00 20 00 00       	push   $0x2000
 7a0:	e8 6b fe ff ff       	call   610 <malloc>
  if (!stk) return -1;
 ...
 7ac:	74 d9                	je     787 <thread_create+0x27>
  memset(stk, 0, STACK_SIZE);
 7ae:	83 ec 04             	sub    $0x4,%esp
 7b1:	68 00 20 00 00       	push   $0x2000
 7b6:	6a 00                	push   $0x0
 7b8:	56                   	push   %esi
 7b9:	e8 62 f9 ff ff       	call   120 <memset>
 ...
 7c1:	89 b3 a8 0e 00 00    	mov    %esi,0xea8(%ebx)
  table[slot].ctx   = (struct context*)sp;

  return table[slot].tid;
 7c7:	83 c4 10             	add    $0x10,%esp
  sp--;  *sp = 0xffffffff;
 7ca:	c7 86 f4 1f 00 00 ff 	movl   $0xffffffff,0x1ff4(%esi)
 7d1:	ff ff ff 
  sp--;  *sp = 0;   /* edi */
 7d4:	81 c6 e0 1f 00 00    	add    $0x1fe0,%esi
  sp--;  *sp = (uint)arg;
 7da:	89 46 1c             	mov    %eax,0x1c(%esi)
  sp--;  *sp = (uint)fn;
 7dd:	8b 45 08             	mov    0x8(%ebp),%eax
  sp--;  *sp = (uint)thread_stub;
 7e0:	c7 46 10 d0 08 00 00 	movl   $0x8d0,0x10(%esi)
  sp--;  *sp = (uint)fn;
 7e7:	89 46 18             	mov    %eax,0x18(%esi)
  table[slot].tid   = next_tid++;
 7ea:	a1 40 0e 00 00       	mov    0xe40,%eax
  sp--;  *sp = 0;   /* ebp */
 7ef:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
  table[slot].tid   = next_tid++;
 7f6:	8d 48 01             	lea    0x1(%eax),%ecx
  sp--;  *sp = 0;   /* ebx */
 7f9:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)
  sp--;  *sp = 0;   /* esi */
 800:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
  sp--;  *sp = 0;   /* edi */
 807:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  table[slot].state = RUNNABLE;
 80d:	c7 83 a0 0e 00 00 01 	movl   $0x1,0xea0(%ebx)
 814:	00 00 00 
  table[slot].tid   = next_tid++;
 817:	89 0d 40 0e 00 00    	mov    %ecx,0xe40
 81d:	89 83 a4 0e 00 00    	mov    %eax,0xea4(%ebx)
  sp--;  *sp = 0;   /* edi */
 823:	89 b3 ac 0e 00 00    	mov    %esi,0xeac(%ebx)
}
 829:	8d 65 f8             	lea    -0x8(%ebp),%esp
 82c:	5b                   	pop    %ebx
 82d:	5e                   	pop    %esi
 82e:	5d                   	pop    %ebp
 82f:	c3                   	ret
...
void thread_yield(void) {
 ...
 835:	8b 35 94 0e 00 00    	mov    0xe94,%esi
 83b:	8d 4e 01             	lea    0x1(%esi),%ecx
 83e:	8d 5e 11             	lea    0x11(%esi),%ebx
 841:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 848:	89 ca                	mov    %ecx,%edx
 84a:	c1 fa 1f             	sar    $0x1f,%edx
 84d:	c1 ea 1c             	shr    $0x1c,%edx
 850:	8d 04 11             	lea    (%ecx,%edx,1),%eax
 853:	83 e0 0f             	and    $0xf,%eax
 856:	29 d0                	sub    %edx,%eax
    if (table[idx].state == RUNNABLE)
 858:	89 c2                	mov    %eax,%edx
 85a:	c1 e2 04             	shl    $0x4,%edx
 85d:	83 ba a0 0e 00 00 01 	cmpl   $0x1,0xea0(%edx)
 864:	74 12                	je     878 <thread_yield+0x48>
  for (int i = 1; i <= MAX_THREADS; i++) {
 866:	83 c1 01             	add    $0x1,%ecx
 869:	39 d9                	cmp    %ebx,%ecx
 86b:	75 db                	jne    848 <thread_yield+0x18>
 ...
 874:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if (next == -1) return;
 878:	83 f8 ff             	cmp    $0xffffffff,%eax
 87b:	74 f0                	je     86d <thread_yield+0x3d>
  if (table[prev].state == RUNNING)
 87d:	89 f2                	mov    %esi,%edx
 87f:	c1 e2 04             	shl    $0x4,%edx
 882:	83 ba a0 0e 00 00 02 	cmpl   $0x2,0xea0(%edx)
 889:	75 0a                	jne    895 <thread_yield+0x65>
    table[prev].state = RUNNABLE;
 88b:	c7 82 a0 0e 00 00 01 	movl   $0x1,0xea0(%edx)
 892:	00 00 00 
  table[next].state = RUNNING;
 895:	89 c2                	mov    %eax,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 897:	c1 e6 04             	shl    $0x4,%esi
 89a:	83 ec 08             	sub    $0x8,%esp
  current = next;
 89d:	a3 94 0e 00 00       	mov    %eax,0xe94
  table[next].state = RUNNING;
 8a2:	c1 e2 04             	shl    $0x4,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 8a5:	81 c6 ac 0e 00 00    	add    $0xeac,%esi
  table[next].state = RUNNING;
 8ab:	c7 82 a0 0e 00 00 02 	movl   $0x2,0xea0(%edx)
 8b2:	00 00 00 
  uswtch(&table[prev].ctx, table[next].ctx);
 8b5:	ff b2 ac 0e 00 00    	push   0xeac(%edx)
 8bb:	56                   	push   %esi
 8bc:	e8 1d 01 00 00       	call   9de <uswtch>
 8c1:	83 c4 10             	add    $0x10,%esp
}
 8c4:	8d 65 f8             	lea    -0x8(%ebp),%esp
 8c7:	5b                   	pop    %ebx
 8c8:	5e                   	pop    %esi
 8c9:	5d                   	pop    %ebp
 8ca:	c3                   	ret
...
static void thread_stub(void (*fn)(void*), void *arg) {
 ...
 8dc:	a1 94 0e 00 00       	mov    0xe94,%eax
 8e1:	c1 e0 04             	shl    $0x4,%eax
 8e4:	c7 80 a0 0e 00 00 03 	movl   $0x3,0xea0(%eax)
 8eb:	00 00 00 
  thread_yield();
 8ee:	e8 3d ff ff ff       	call   830 <thread_yield>
  exit();
 8f3:	e8 ab f9 ff ff       	call   2a3 <exit>
...
int thread_join(tid_t tid) {
 ...
 912:	c1 e6 04             	shl    $0x4,%esi
 915:	39 86 a4 0e 00 00    	cmp    %eax,0xea4(%esi)
 91b:	74 20                	je     93d <thread_join+0x3d>
  for (int i = 0; i < MAX_THREADS; i++) {
 91d:	83 c3 01             	add    $0x1,%ebx
 920:	83 fb 10             	cmp    $0x10,%ebx
 923:	75 eb                	jne    910 <thread_join+0x10>
 ...
 93d:	83 be a0 0e 00 00 03 	cmpl   $0x3,0xea0(%esi)
 944:	75 f2                	jne    938 <thread_join+0x38>
  if (table[slot].stack)
 946:	89 d8                	mov    %ebx,%eax
 948:	c1 e0 04             	shl    $0x4,%eax
 94b:	8b 80 a8 0e 00 00    	mov    0xea8(%eax),%eax
 951:	85 c0                	test   %eax,%eax
 953:	74 0c                	je     961 <thread_join+0x61>
    free(table[slot].stack);
 955:	83 ec 0c             	sub    $0xc,%esp
 958:	50                   	push   %eax
 959:	e8 22 fc ff ff       	call   580 <free>
 95e:	83 c4 10             	add    $0x10,%esp
  table[slot].state = FREE;
 961:	c1 e3 04             	shl    $0x4,%ebx
  return 0;
 964:	31 c0                	xor    %eax,%eax
  table[slot].state = FREE;
 966:	c7 83 a0 0e 00 00 00 	movl   $0x0,0xea0(%ebx)
 96d:	00 00 00 
  table[slot].stack = 0;
 970:	c7 83 a8 0e 00 00 00 	movl   $0x0,0xea8(%ebx)
 977:	00 00 00 
  table[slot].ctx   = 0;
 97a:	c7 83 ac 0e 00 00 00 	movl   $0x0,0xeac(%ebx)
 981:	00 00 00 
 984:	8d 65 f8             	lea    -0x8(%ebp),%esp
 987:	5b                   	pop    %ebx
 988:	5e                   	pop    %esi
 989:	5d                   	pop    %ebp
 98a:	c3                   	ret
...
void mutex_lock(umutex_t *m){ while(m->locked){ thread_yield(); } m->locked = 1; }
 ...
 9b0:	e8 7b fe ff ff       	call   830 <thread_yield>
 ...
 9c4:	c9                   	leave
 9c5:	c3                   	ret
 9c6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 9cd:	00 
