 ...
 408:	89 d1                	mov    %edx,%ecx
{
 ...
 43b:	0f b6 92 3c 0b 00 00 	movzbl 0xb3c(%edx),%edx
 ...
 4a9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 514:	ff 24 85 e4 0a 00 00 	jmp    *0xae4(,%eax,4)
 ...
 620:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 625:	bb dc 0a 00 00       	mov    $0xadc,%ebx
...
free(void *ap)
{
 ...
 631:	a1 40 11 00 00       	mov    0x1140,%eax
{
 ...
 66f:	5b                   	pop    %ebx
  freep = p;
 670:	a3 40 11 00 00       	mov    %eax,0x1140
}
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 677:	5d                   	pop    %ebp
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 40 11 00 00       	mov    %eax,0x1140
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 40 11 00 00    	mov    0x1140,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70b:	3b 05 40 11 00 00    	cmp    0x1140,%eax
 ...
 72e:	e8 fd fe ff ff       	call   630 <free>
  return freep;
 733:	8b 15 40 11 00 00    	mov    0x1140,%edx
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 75f:	89 15 40 11 00 00    	mov    %edx,0x1140
}
 ...
 76f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 40 11 00 00 44 	movl   $0x1144,0x1140
 777:	11 00 00 
    base.s.size = 0;
 77a:	b8 44 11 00 00       	mov    $0x1144,%eax
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 44 11 00 00 44 	movl   $0x1144,0x1144
 786:	11 00 00 
    base.s.size = 0;
 789:	c7 05 48 11 00 00 00 	movl   $0x0,0x1148
 790:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 7b0:	b8 80 11 00 00       	mov    $0x1180,%eax
 7b5:	8d 76 00             	lea    0x0(%esi),%esi
    table[i].state = FREE;
 7b8:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 7be:	83 c0 20             	add    $0x20,%eax
    table[i].state = FREE;
 7c1:	c7 40 f0 00 00 00 00 	movl   $0x0,-0x10(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 7c8:	3d 80 12 00 00       	cmp    $0x1280,%eax
 7cd:	75 e9                	jne    7b8 <thread_init+0x8>
 
  table[0].state = RUNNING;
  table[0].tid   = next_tid++;
 7cf:	a1 38 0f 00 00       	mov    0xf38,%eax
  table[0].state = RUNNING;
 7d4:	c7 05 80 11 00 00 02 	movl   $0x2,0x1180
 7db:	00 00 00 
  table[0].stack = 0;   
 7de:	c7 05 88 11 00 00 00 	movl   $0x0,0x1188
 7e5:	00 00 00 
  table[0].tid   = next_tid++;
 7e8:	8d 50 01             	lea    0x1(%eax),%edx
 7eb:	a3 84 11 00 00       	mov    %eax,0x1184
 7f0:	89 15 38 0f 00 00    	mov    %edx,0xf38
  table[0].ctx   = &main_ctx;
 7f6:	c7 05 8c 11 00 00 60 	movl   $0x1160,0x118c
 7fd:	11 00 00 
  current = 0;
 800:	c7 05 74 11 00 00 00 	movl   $0x0,0x1174
 807:	00 00 00 
}
 80a:	c3                   	ret
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 820:	89 c3                	mov    %eax,%ebx
 822:	c1 e3 04             	shl    $0x4,%ebx
 825:	8b 93 80 11 00 00    	mov    0x1180(%ebx),%edx
 82b:	85 d2                	test   %edx,%edx
 82d:	74 19                	je     848 <thread_create+0x38>
  for (int i = 1; i < MAX_THREADS; i++) {
 82f:	83 c0 01             	add    $0x1,%eax
 832:	83 f8 10             	cmp    $0x10,%eax
 835:	75 e9                	jne    820 <thread_create+0x10>
  }
  if (slot == -1) return -1;
 837:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 83c:	e9 98 00 00 00       	jmp    8d9 <thread_create+0xc9>
 841:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 
  char *stk = malloc(STACK_SIZE);
 848:	83 ec 0c             	sub    $0xc,%esp
 84b:	68 00 20 00 00       	push   $0x2000
 850:	e8 6b fe ff ff       	call   6c0 <malloc>
  if (!stk) return -1;
 ...
 85c:	74 d9                	je     837 <thread_create+0x27>
  memset(stk, 0, STACK_SIZE);
 85e:	83 ec 04             	sub    $0x4,%esp
 861:	68 00 20 00 00       	push   $0x2000
 866:	6a 00                	push   $0x0
 868:	56                   	push   %esi
 869:	e8 62 f9 ff ff       	call   1d0 <memset>
 ...
 871:	89 b3 88 11 00 00    	mov    %esi,0x1188(%ebx)
  table[slot].ctx   = (struct context*)sp;

  return table[slot].tid;
 877:	83 c4 10             	add    $0x10,%esp
  sp--;  *sp = 0xffffffff;
 87a:	c7 86 f4 1f 00 00 ff 	movl   $0xffffffff,0x1ff4(%esi)
 881:	ff ff ff 
  sp--;  *sp = 0;   /* edi */
 884:	81 c6 e0 1f 00 00    	add    $0x1fe0,%esi
  sp--;  *sp = (uint)arg;
 88a:	89 46 1c             	mov    %eax,0x1c(%esi)
  sp--;  *sp = (uint)fn;
 88d:	8b 45 08             	mov    0x8(%ebp),%eax
  sp--;  *sp = (uint)thread_stub;
 890:	c7 46 10 80 09 00 00 	movl   $0x980,0x10(%esi)
  sp--;  *sp = (uint)fn;
 897:	89 46 18             	mov    %eax,0x18(%esi)
  table[slot].tid   = next_tid++;
 89a:	a1 38 0f 00 00       	mov    0xf38,%eax
  sp--;  *sp = 0;   /* ebp */
 89f:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
  table[slot].tid   = next_tid++;
 8a6:	8d 48 01             	lea    0x1(%eax),%ecx
  sp--;  *sp = 0;   /* ebx */
 8a9:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)
  sp--;  *sp = 0;   /* esi */
 8b0:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
  sp--;  *sp = 0;   /* edi */
 8b7:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  table[slot].state = RUNNABLE;
 8bd:	c7 83 80 11 00 00 01 	movl   $0x1,0x1180(%ebx)
 8c4:	00 00 00 
  table[slot].tid   = next_tid++;
 8c7:	89 0d 38 0f 00 00    	mov    %ecx,0xf38
 8cd:	89 83 84 11 00 00    	mov    %eax,0x1184(%ebx)
  sp--;  *sp = 0;   /* edi */
 8d3:	89 b3 8c 11 00 00    	mov    %esi,0x118c(%ebx)
}
...
void thread_yield(void) {
 ...
 8e5:	8b 35 74 11 00 00    	mov    0x1174,%esi
 8eb:	8d 4e 01             	lea    0x1(%esi),%ecx
 8ee:	8d 5e 11             	lea    0x11(%esi),%ebx
 8f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 8f8:	89 ca                	mov    %ecx,%edx
 8fa:	c1 fa 1f             	sar    $0x1f,%edx
 8fd:	c1 ea 1c             	shr    $0x1c,%edx
 900:	8d 04 11             	lea    (%ecx,%edx,1),%eax
 903:	83 e0 0f             	and    $0xf,%eax
 906:	29 d0                	sub    %edx,%eax
    if (table[idx].state == RUNNABLE)
 908:	89 c2                	mov    %eax,%edx
 90a:	c1 e2 04             	shl    $0x4,%edx
 90d:	83 ba 80 11 00 00 01 	cmpl   $0x1,0x1180(%edx)
 914:	74 12                	je     928 <thread_yield+0x48>
  for (int i = 1; i <= MAX_THREADS; i++) {
 916:	83 c1 01             	add    $0x1,%ecx
 919:	39 d9                	cmp    %ebx,%ecx
 91b:	75 db                	jne    8f8 <thread_yield+0x18>
 ...
 92b:	74 f0                	je     91d <thread_yield+0x3d>
  if (table[prev].state == RUNNING)
 92d:	89 f2                	mov    %esi,%edx
 92f:	c1 e2 04             	shl    $0x4,%edx
 932:	83 ba 80 11 00 00 02 	cmpl   $0x2,0x1180(%edx)
 939:	75 0a                	jne    945 <thread_yield+0x65>
    table[prev].state = RUNNABLE;
 93b:	c7 82 80 11 00 00 01 	movl   $0x1,0x1180(%edx)
 942:	00 00 00 
  table[next].state = RUNNING;
 945:	89 c2                	mov    %eax,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 947:	c1 e6 04             	shl    $0x4,%esi
 94a:	83 ec 08             	sub    $0x8,%esp
  current = next;
 94d:	a3 74 11 00 00       	mov    %eax,0x1174
  table[next].state = RUNNING;
 952:	c1 e2 04             	shl    $0x4,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 955:	81 c6 8c 11 00 00    	add    $0x118c,%esi
  table[next].state = RUNNING;
 95b:	c7 82 80 11 00 00 02 	movl   $0x2,0x1180(%edx)
 962:	00 00 00 
  uswtch(&table[prev].ctx, table[next].ctx);
 965:	ff b2 8c 11 00 00    	push   0x118c(%edx)
 96b:	56                   	push   %esi
 96c:	e8 1d 01 00 00       	call   a8e <uswtch>
...
static void thread_stub(void (*fn)(void*), void *arg) {
 ...
 98c:	a1 74 11 00 00       	mov    0x1174,%eax
 991:	c1 e0 04             	shl    $0x4,%eax
 994:	c7 80 80 11 00 00 03 	movl   $0x3,0x1180(%eax)
 99b:	00 00 00 
  thread_yield();
 99e:	e8 3d ff ff ff       	call   8e0 <thread_yield>
  exit();
 9a3:	e8 ab f9 ff ff       	call   353 <exit>
...
int thread_join(tid_t tid) {
 ...
 9c0:	89 de                	mov    %ebx,%esi
 9c2:	c1 e6 04             	shl    $0x4,%esi
 9c5:	39 86 84 11 00 00    	cmp    %eax,0x1184(%esi)
 9cb:	74 20                	je     9ed <thread_join+0x3d>
  for (int i = 0; i < MAX_THREADS; i++) {
 9cd:	83 c3 01             	add    $0x1,%ebx
 9d0:	83 fb 10             	cmp    $0x10,%ebx
 9d3:	75 eb                	jne    9c0 <thread_join+0x10>
  table[slot].state = FREE;
  table[slot].stack = 0;
  table[slot].ctx   = 0;
 
  return 0;
 9d5:	8d 65 f8             	lea    -0x8(%ebp),%esp
  if (slot == -1) return -1;
 ...
 9ed:	83 be 80 11 00 00 03 	cmpl   $0x3,0x1180(%esi)
 9f4:	75 f2                	jne    9e8 <thread_join+0x38>
  if (table[slot].stack)
 9f6:	89 d8                	mov    %ebx,%eax
 9f8:	c1 e0 04             	shl    $0x4,%eax
 9fb:	8b 80 88 11 00 00    	mov    0x1188(%eax),%eax
 a01:	85 c0                	test   %eax,%eax
 a03:	74 0c                	je     a11 <thread_join+0x61>
    free(table[slot].stack);
 a05:	83 ec 0c             	sub    $0xc,%esp
 a08:	50                   	push   %eax
 a09:	e8 22 fc ff ff       	call   630 <free>
 a0e:	83 c4 10             	add    $0x10,%esp
  table[slot].state = FREE;
 a11:	c1 e3 04             	shl    $0x4,%ebx
  return 0;
 a14:	31 c0                	xor    %eax,%eax
  table[slot].state = FREE;
 a16:	c7 83 80 11 00 00 00 	movl   $0x0,0x1180(%ebx)
 a1d:	00 00 00 
  table[slot].stack = 0;
 a20:	c7 83 88 11 00 00 00 	movl   $0x0,0x1188(%ebx)
 a27:	00 00 00 
  table[slot].ctx   = 0;
 a2a:	c7 83 8c 11 00 00 00 	movl   $0x0,0x118c(%ebx)
 a31:	00 00 00 
...
void mutex_init(umutex_t *m){ m->locked = 0; }
 ...
 a46:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
 a4c:	5d                   	pop    %ebp
 a4d:	c3                   	ret
...
void mutex_lock(umutex_t *m){ while(m->locked){ thread_yield(); } m->locked = 1; }
 ...
 a5a:	8b 03                	mov    (%ebx),%eax
 a5c:	85 c0                	test   %eax,%eax
 a5e:	74 0b                	je     a6b <mutex_lock+0x1b>
 a60:	e8 7b fe ff ff       	call   8e0 <thread_yield>
 a65:	8b 03                	mov    (%ebx),%eax
 a67:	85 c0                	test   %eax,%eax
 a69:	75 f5                	jne    a60 <mutex_lock+0x10>
 a6b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
...
uswtch:
  movl 4(%esp), %eax
 a8e:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
 a92:	8b 54 24 08          	mov    0x8(%esp),%edx
 ...
 a99:	57                   	push   %edi
  ...
  movl %esp, (%eax)
 a9a:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
 a9c:	89 d4                	mov    %edx,%esp
