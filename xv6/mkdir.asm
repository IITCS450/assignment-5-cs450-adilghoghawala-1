 ...
 378:	89 d1                	mov    %edx,%ecx
{
 ...
 3ab:	0f b6 92 a8 0a 00 00 	movzbl 0xaa8(%edx),%edx
 ...
 419:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 484:	ff 24 85 50 0a 00 00 	jmp    *0xa50(,%eax,4)
 ...
 590:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 595:	bb 47 0a 00 00       	mov    $0xa47,%ebx
...
free(void *ap)
{
 ...
 5a1:	a1 80 0e 00 00       	mov    0xe80,%eax
{
 ...
 5df:	5b                   	pop    %ebx
  freep = p;
 5e0:	a3 80 0e 00 00       	mov    %eax,0xe80
}
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 5e7:	5d                   	pop    %ebp
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 80 0e 00 00       	mov    %eax,0xe80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 80 0e 00 00    	mov    0xe80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67b:	3b 05 80 0e 00 00    	cmp    0xe80,%eax
 ...
 69e:	e8 fd fe ff ff       	call   5a0 <free>
  return freep;
 6a3:	8b 15 80 0e 00 00    	mov    0xe80,%edx
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6cf:	89 15 80 0e 00 00    	mov    %edx,0xe80
}
 ...
 6df:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 80 0e 00 00 84 	movl   $0xe84,0xe80
 6e7:	0e 00 00 
    base.s.size = 0;
 6ea:	b8 84 0e 00 00       	mov    $0xe84,%eax
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 84 0e 00 00 84 	movl   $0xe84,0xe84
 6f6:	0e 00 00 
    base.s.size = 0;
 6f9:	c7 05 88 0e 00 00 00 	movl   $0x0,0xe88
 700:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 720:	b8 c0 0e 00 00       	mov    $0xec0,%eax
 725:	8d 76 00             	lea    0x0(%esi),%esi
    table[i].state = FREE;
 728:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 72e:	83 c0 20             	add    $0x20,%eax
    table[i].state = FREE;
 731:	c7 40 f0 00 00 00 00 	movl   $0x0,-0x10(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 738:	3d c0 0f 00 00       	cmp    $0xfc0,%eax
 73d:	75 e9                	jne    728 <thread_init+0x8>
 
  table[0].state = RUNNING;
  table[0].tid   = next_tid++;
 73f:	a1 78 0e 00 00       	mov    0xe78,%eax
  table[0].state = RUNNING;
 744:	c7 05 c0 0e 00 00 02 	movl   $0x2,0xec0
 74b:	00 00 00 
  table[0].stack = 0;   
 74e:	c7 05 c8 0e 00 00 00 	movl   $0x0,0xec8
 755:	00 00 00 
  table[0].tid   = next_tid++;
 758:	8d 50 01             	lea    0x1(%eax),%edx
 75b:	a3 c4 0e 00 00       	mov    %eax,0xec4
 760:	89 15 78 0e 00 00    	mov    %edx,0xe78
  table[0].ctx   = &main_ctx;
 766:	c7 05 cc 0e 00 00 a0 	movl   $0xea0,0xecc
 76d:	0e 00 00 
  current = 0;
 770:	c7 05 b4 0e 00 00 00 	movl   $0x0,0xeb4
 777:	00 00 00 
}
 77a:	c3                   	ret
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 7cc:	74 d9                	je     7a7 <thread_create+0x27>
  memset(stk, 0, STACK_SIZE);
 7ce:	83 ec 04             	sub    $0x4,%esp
 7d1:	68 00 20 00 00       	push   $0x2000
 7d6:	6a 00                	push   $0x0
 7d8:	56                   	push   %esi
 7d9:	e8 62 f9 ff ff       	call   140 <memset>
 ...
 7e1:	89 b3 c8 0e 00 00    	mov    %esi,0xec8(%ebx)
  table[slot].ctx   = (struct context*)sp;

  return table[slot].tid;
 7e7:	83 c4 10             	add    $0x10,%esp
  sp--;  *sp = 0xffffffff;
 7ea:	c7 86 f4 1f 00 00 ff 	movl   $0xffffffff,0x1ff4(%esi)
 7f1:	ff ff ff 
  sp--;  *sp = 0;   /* edi */
 7f4:	81 c6 e0 1f 00 00    	add    $0x1fe0,%esi
  sp--;  *sp = (uint)arg;
 7fa:	89 46 1c             	mov    %eax,0x1c(%esi)
  sp--;  *sp = (uint)fn;
 7fd:	8b 45 08             	mov    0x8(%ebp),%eax
  sp--;  *sp = (uint)thread_stub;
 800:	c7 46 10 f0 08 00 00 	movl   $0x8f0,0x10(%esi)
  sp--;  *sp = (uint)fn;
 807:	89 46 18             	mov    %eax,0x18(%esi)
  table[slot].tid   = next_tid++;
 80a:	a1 78 0e 00 00       	mov    0xe78,%eax
  sp--;  *sp = 0;   /* ebp */
 80f:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
  table[slot].tid   = next_tid++;
 816:	8d 48 01             	lea    0x1(%eax),%ecx
  sp--;  *sp = 0;   /* ebx */
 819:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)
  sp--;  *sp = 0;   /* esi */
 820:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
  sp--;  *sp = 0;   /* edi */
 827:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  table[slot].state = RUNNABLE;
 82d:	c7 83 c0 0e 00 00 01 	movl   $0x1,0xec0(%ebx)
 834:	00 00 00 
  table[slot].tid   = next_tid++;
 837:	89 0d 78 0e 00 00    	mov    %ecx,0xe78
 83d:	89 83 c4 0e 00 00    	mov    %eax,0xec4(%ebx)
  sp--;  *sp = 0;   /* edi */
 843:	89 b3 cc 0e 00 00    	mov    %esi,0xecc(%ebx)
}
 849:	8d 65 f8             	lea    -0x8(%ebp),%esp
 84c:	5b                   	pop    %ebx
 84d:	5e                   	pop    %esi
 84e:	5d                   	pop    %ebp
 84f:	c3                   	ret
...
void thread_yield(void) {
 ...
 855:	8b 35 b4 0e 00 00    	mov    0xeb4,%esi
 85b:	8d 4e 01             	lea    0x1(%esi),%ecx
 85e:	8d 5e 11             	lea    0x11(%esi),%ebx
 861:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 868:	89 ca                	mov    %ecx,%edx
 86a:	c1 fa 1f             	sar    $0x1f,%edx
 86d:	c1 ea 1c             	shr    $0x1c,%edx
 870:	8d 04 11             	lea    (%ecx,%edx,1),%eax
 873:	83 e0 0f             	and    $0xf,%eax
 876:	29 d0                	sub    %edx,%eax
    if (table[idx].state == RUNNABLE)
 878:	89 c2                	mov    %eax,%edx
 87a:	c1 e2 04             	shl    $0x4,%edx
 87d:	83 ba c0 0e 00 00 01 	cmpl   $0x1,0xec0(%edx)
 884:	74 12                	je     898 <thread_yield+0x48>
  for (int i = 1; i <= MAX_THREADS; i++) {
 886:	83 c1 01             	add    $0x1,%ecx
 889:	39 d9                	cmp    %ebx,%ecx
 88b:	75 db                	jne    868 <thread_yield+0x18>
 ...
 894:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if (next == -1) return;
 898:	83 f8 ff             	cmp    $0xffffffff,%eax
 89b:	74 f0                	je     88d <thread_yield+0x3d>
  if (table[prev].state == RUNNING)
 89d:	89 f2                	mov    %esi,%edx
 89f:	c1 e2 04             	shl    $0x4,%edx
 8a2:	83 ba c0 0e 00 00 02 	cmpl   $0x2,0xec0(%edx)
 8a9:	75 0a                	jne    8b5 <thread_yield+0x65>
    table[prev].state = RUNNABLE;
 8ab:	c7 82 c0 0e 00 00 01 	movl   $0x1,0xec0(%edx)
 8b2:	00 00 00 
  table[next].state = RUNNING;
 8b5:	89 c2                	mov    %eax,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 8b7:	c1 e6 04             	shl    $0x4,%esi
 8ba:	83 ec 08             	sub    $0x8,%esp
  current = next;
 8bd:	a3 b4 0e 00 00       	mov    %eax,0xeb4
  table[next].state = RUNNING;
 8c2:	c1 e2 04             	shl    $0x4,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 8c5:	81 c6 cc 0e 00 00    	add    $0xecc,%esi
  table[next].state = RUNNING;
 8cb:	c7 82 c0 0e 00 00 02 	movl   $0x2,0xec0(%edx)
 8d2:	00 00 00 
  uswtch(&table[prev].ctx, table[next].ctx);
 8d5:	ff b2 cc 0e 00 00    	push   0xecc(%edx)
 8db:	56                   	push   %esi
 8dc:	e8 1d 01 00 00       	call   9fe <uswtch>
 ...
 8e9:	5d                   	pop    %ebp
 8ea:	c3                   	ret
 8eb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi

000008f0 <thread_stub>:
static void thread_stub(void (*fn)(void*), void *arg) {
 8f0:	55                   	push   %ebp
 8f1:	89 e5                	mov    %esp,%ebp
 8f3:	83 ec 14             	sub    $0x14,%esp
  fn(arg);
 8f6:	ff 75 0c             	push   0xc(%ebp)
 8f9:	ff 55 08             	call   *0x8(%ebp)
  table[current].state = ZOMBIE;
 8fc:	a1 b4 0e 00 00       	mov    0xeb4,%eax
 901:	c1 e0 04             	shl    $0x4,%eax
 904:	c7 80 c0 0e 00 00 03 	movl   $0x3,0xec0(%eax)
 90b:	00 00 00 
  thread_yield();
 90e:	e8 3d ff ff ff       	call   850 <thread_yield>
  exit();
 913:	e8 ab f9 ff ff       	call   2c3 <exit>
 918:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 91f:	00 

00000920 <thread_join>:
...
int thread_join(tid_t tid) {
 ...
 930:	89 de                	mov    %ebx,%esi
 932:	c1 e6 04             	shl    $0x4,%esi
 935:	39 86 c4 0e 00 00    	cmp    %eax,0xec4(%esi)
 93b:	74 20                	je     95d <thread_join+0x3d>
  for (int i = 0; i < MAX_THREADS; i++) {
 93d:	83 c3 01             	add    $0x1,%ebx
 940:	83 fb 10             	cmp    $0x10,%ebx
 943:	75 eb                	jne    930 <thread_join+0x10>
 ...
 95d:	83 be c0 0e 00 00 03 	cmpl   $0x3,0xec0(%esi)
 964:	75 f2                	jne    958 <thread_join+0x38>
  if (table[slot].stack)
 966:	89 d8                	mov    %ebx,%eax
 968:	c1 e0 04             	shl    $0x4,%eax
 96b:	8b 80 c8 0e 00 00    	mov    0xec8(%eax),%eax
 971:	85 c0                	test   %eax,%eax
 973:	74 0c                	je     981 <thread_join+0x61>
    free(table[slot].stack);
 975:	83 ec 0c             	sub    $0xc,%esp
 978:	50                   	push   %eax
 979:	e8 22 fc ff ff       	call   5a0 <free>
 97e:	83 c4 10             	add    $0x10,%esp
  table[slot].state = FREE;
 981:	c1 e3 04             	shl    $0x4,%ebx
  return 0;
 984:	31 c0                	xor    %eax,%eax
  table[slot].state = FREE;
 986:	c7 83 c0 0e 00 00 00 	movl   $0x0,0xec0(%ebx)
 98d:	00 00 00 
  table[slot].stack = 0;
 990:	c7 83 c8 0e 00 00 00 	movl   $0x0,0xec8(%ebx)
 997:	00 00 00 
  table[slot].ctx   = 0;
 99a:	c7 83 cc 0e 00 00 00 	movl   $0x0,0xecc(%ebx)
 9a1:	00 00 00 
 9a4:	8d 65 f8             	lea    -0x8(%ebp),%esp
 9a7:	5b                   	pop    %ebx
 9a8:	5e                   	pop    %esi
 9a9:	5d                   	pop    %ebp
 9aa:	c3                   	ret
...
void mutex_lock(umutex_t *m){ while(m->locked){ thread_yield(); } m->locked = 1; }
 ...
 9ca:	8b 03                	mov    (%ebx),%eax
 9cc:	85 c0                	test   %eax,%eax
 9ce:	74 0b                	je     9db <mutex_lock+0x1b>
 9d0:	e8 7b fe ff ff       	call   850 <thread_yield>
 9d5:	8b 03                	mov    (%ebx),%eax
 9d7:	85 c0                	test   %eax,%eax
 9d9:	75 f5                	jne    9d0 <mutex_lock+0x10>
 9db:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
 9e1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 9e4:	c9                   	leave
 9e5:	c3                   	ret
 9e6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 9ed:	00 
 9ee:	66 90                	xchg   %ax,%ax

000009f0 <mutex_unlock>:
...
uswtch:
  movl 4(%esp), %eax
 9fe:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
 a02:	8b 54 24 08          	mov    0x8(%esp),%edx
 ...
 a09:	57                   	push   %edi
  ...
  movl %esp, (%eax)
 a0a:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
 a0c:	89 d4                	mov    %edx,%esp
