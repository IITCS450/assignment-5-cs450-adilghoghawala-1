 ...
 378:	89 d1                	mov    %edx,%ecx
{
 ...
 3ab:	0f b6 92 a0 0a 00 00 	movzbl 0xaa0(%edx),%edx
 ...
 419:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 484:	ff 24 85 48 0a 00 00 	jmp    *0xa48(,%eax,4)
 ...
 590:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 595:	bb 41 0a 00 00       	mov    $0xa41,%ebx
...
void thread_init(void) {
 ...
 73f:	a1 70 0e 00 00       	mov    0xe70,%eax
  table[0].state = RUNNING;
 ...
 760:	89 15 70 0e 00 00    	mov    %edx,0xe70
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 807:	89 46 18             	mov    %eax,0x18(%esi)
  table[slot].tid   = next_tid++;
 80a:	a1 70 0e 00 00       	mov    0xe70,%eax
  sp--;  *sp = 0;   /* ebp */
 ...
 834:	00 00 00 
  table[slot].tid   = next_tid++;
 837:	89 0d 70 0e 00 00    	mov    %ecx,0xe70
