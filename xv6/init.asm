...
main(void)
{
  ...
  ab:	68 b2 0a 00 00       	push   $0xab2
  b0:	e8 b6 02 00 00       	call   36b <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 b5 0a 00 00       	push   $0xab5
  bc:	6a 01                	push   $0x1
  ...
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 84 0a 00 00       	push   $0xa84
  d2:	e8 a4 02 00 00       	call   37b <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 84 0a 00 00       	push   $0xa84
 ...
 3e8:	89 d1                	mov    %edx,%ecx
{
 ...
 41b:	0f b6 92 34 0b 00 00 	movzbl 0xb34(%edx),%edx
 ...
 489:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4f4:	ff 24 85 dc 0a 00 00 	jmp    *0xadc(,%eax,4)
 ...
 600:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 605:	bb d4 0a 00 00       	mov    $0xad4,%ebx
...
free(void *ap)
{
 ...
 611:	a1 20 0f 00 00       	mov    0xf20,%eax
{
 ...
 64f:	5b                   	pop    %ebx
  freep = p;
 650:	a3 20 0f 00 00       	mov    %eax,0xf20
}
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 657:	5d                   	pop    %ebp
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 20 0f 00 00       	mov    %eax,0xf20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 20 0f 00 00    	mov    0xf20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6eb:	3b 05 20 0f 00 00    	cmp    0xf20,%eax
 ...
 70e:	e8 fd fe ff ff       	call   610 <free>
  return freep;
 713:	8b 15 20 0f 00 00    	mov    0xf20,%edx
 ...
 73c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 73f:	89 15 20 0f 00 00    	mov    %edx,0xf20
}
 ...
 74f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 20 0f 00 00 24 	movl   $0xf24,0xf20
 757:	0f 00 00 
    base.s.size = 0;
 75a:	b8 24 0f 00 00       	mov    $0xf24,%eax
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 24 0f 00 00 24 	movl   $0xf24,0xf24
 766:	0f 00 00 
    base.s.size = 0;
 769:	c7 05 28 0f 00 00 00 	movl   $0x0,0xf28
 770:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
 ...
 790:	b8 60 0f 00 00       	mov    $0xf60,%eax
 795:	8d 76 00             	lea    0x0(%esi),%esi
    table[i].state = FREE;
 798:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 79e:	83 c0 20             	add    $0x20,%eax
    table[i].state = FREE;
 7a1:	c7 40 f0 00 00 00 00 	movl   $0x0,-0x10(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
 7a8:	3d 60 10 00 00       	cmp    $0x1060,%eax
 7ad:	75 e9                	jne    798 <thread_init+0x8>
 
  table[0].state = RUNNING;
  table[0].tid   = next_tid++;
 7af:	a1 00 0f 00 00       	mov    0xf00,%eax
  table[0].state = RUNNING;
 7b4:	c7 05 60 0f 00 00 02 	movl   $0x2,0xf60
 7bb:	00 00 00 
  table[0].stack = 0;   
 7be:	c7 05 68 0f 00 00 00 	movl   $0x0,0xf68
 7c5:	00 00 00 
  table[0].tid   = next_tid++;
 7c8:	8d 50 01             	lea    0x1(%eax),%edx
 7cb:	a3 64 0f 00 00       	mov    %eax,0xf64
 7d0:	89 15 00 0f 00 00    	mov    %edx,0xf00
  table[0].ctx   = &main_ctx;
 7d6:	c7 05 6c 0f 00 00 40 	movl   $0xf40,0xf6c
 7dd:	0f 00 00 
  current = 0;
 7e0:	c7 05 54 0f 00 00 00 	movl   $0x0,0xf54
 7e7:	00 00 00 
}
 7ea:	c3                   	ret
...
tid_t thread_create(void (*fn)(void*), void *arg) {
 ...
 802:	c1 e3 04             	shl    $0x4,%ebx
 805:	8b 93 60 0f 00 00    	mov    0xf60(%ebx),%edx
 ...
 83c:	74 d9                	je     817 <thread_create+0x27>
  memset(stk, 0, STACK_SIZE);
 83e:	83 ec 04             	sub    $0x4,%esp
 841:	68 00 20 00 00       	push   $0x2000
 846:	6a 00                	push   $0x0
 848:	56                   	push   %esi
 849:	e8 62 f9 ff ff       	call   1b0 <memset>
 ...
 851:	89 b3 68 0f 00 00    	mov    %esi,0xf68(%ebx)
  table[slot].ctx   = (struct context*)sp;

  return table[slot].tid;
 857:	83 c4 10             	add    $0x10,%esp
  sp--;  *sp = 0xffffffff;
 85a:	c7 86 f4 1f 00 00 ff 	movl   $0xffffffff,0x1ff4(%esi)
 861:	ff ff ff 
  sp--;  *sp = 0;   /* edi */
 864:	81 c6 e0 1f 00 00    	add    $0x1fe0,%esi
  sp--;  *sp = (uint)arg;
 86a:	89 46 1c             	mov    %eax,0x1c(%esi)
  sp--;  *sp = (uint)fn;
 86d:	8b 45 08             	mov    0x8(%ebp),%eax
  sp--;  *sp = (uint)thread_stub;
 870:	c7 46 10 60 09 00 00 	movl   $0x960,0x10(%esi)
  sp--;  *sp = (uint)fn;
 877:	89 46 18             	mov    %eax,0x18(%esi)
  table[slot].tid   = next_tid++;
 87a:	a1 00 0f 00 00       	mov    0xf00,%eax
  sp--;  *sp = 0;   /* ebp */
 87f:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
  table[slot].tid   = next_tid++;
 886:	8d 48 01             	lea    0x1(%eax),%ecx
  sp--;  *sp = 0;   /* ebx */
 889:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)
  sp--;  *sp = 0;   /* esi */
 890:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
  sp--;  *sp = 0;   /* edi */
 897:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  table[slot].state = RUNNABLE;
 89d:	c7 83 60 0f 00 00 01 	movl   $0x1,0xf60(%ebx)
 8a4:	00 00 00 
  table[slot].tid   = next_tid++;
 8a7:	89 0d 00 0f 00 00    	mov    %ecx,0xf00
 8ad:	89 83 64 0f 00 00    	mov    %eax,0xf64(%ebx)
  sp--;  *sp = 0;   /* edi */
 8b3:	89 b3 6c 0f 00 00    	mov    %esi,0xf6c(%ebx)
}
...
void thread_yield(void) {
 ...
 8c5:	8b 35 54 0f 00 00    	mov    0xf54,%esi
 8cb:	8d 4e 01             	lea    0x1(%esi),%ecx
 8ce:	8d 5e 11             	lea    0x11(%esi),%ebx
 8d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 8d8:	89 ca                	mov    %ecx,%edx
 8da:	c1 fa 1f             	sar    $0x1f,%edx
 8dd:	c1 ea 1c             	shr    $0x1c,%edx
 8e0:	8d 04 11             	lea    (%ecx,%edx,1),%eax
 8e3:	83 e0 0f             	and    $0xf,%eax
 8e6:	29 d0                	sub    %edx,%eax
    if (table[idx].state == RUNNABLE)
 8e8:	89 c2                	mov    %eax,%edx
 8ea:	c1 e2 04             	shl    $0x4,%edx
 8ed:	83 ba 60 0f 00 00 01 	cmpl   $0x1,0xf60(%edx)
 8f4:	74 12                	je     908 <thread_yield+0x48>
  for (int i = 1; i <= MAX_THREADS; i++) {
 8f6:	83 c1 01             	add    $0x1,%ecx
 8f9:	39 d9                	cmp    %ebx,%ecx
 8fb:	75 db                	jne    8d8 <thread_yield+0x18>
 ...
 904:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if (next == -1) return;
 908:	83 f8 ff             	cmp    $0xffffffff,%eax
 90b:	74 f0                	je     8fd <thread_yield+0x3d>
  if (table[prev].state == RUNNING)
 90d:	89 f2                	mov    %esi,%edx
 90f:	c1 e2 04             	shl    $0x4,%edx
 912:	83 ba 60 0f 00 00 02 	cmpl   $0x2,0xf60(%edx)
 919:	75 0a                	jne    925 <thread_yield+0x65>
    table[prev].state = RUNNABLE;
 91b:	c7 82 60 0f 00 00 01 	movl   $0x1,0xf60(%edx)
 922:	00 00 00 
  table[next].state = RUNNING;
 925:	89 c2                	mov    %eax,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 927:	c1 e6 04             	shl    $0x4,%esi
 92a:	83 ec 08             	sub    $0x8,%esp
  current = next;
 92d:	a3 54 0f 00 00       	mov    %eax,0xf54
  table[next].state = RUNNING;
 932:	c1 e2 04             	shl    $0x4,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
 935:	81 c6 6c 0f 00 00    	add    $0xf6c,%esi
  table[next].state = RUNNING;
 93b:	c7 82 60 0f 00 00 02 	movl   $0x2,0xf60(%edx)
 942:	00 00 00 
  uswtch(&table[prev].ctx, table[next].ctx);
 945:	ff b2 6c 0f 00 00    	push   0xf6c(%edx)
 94b:	56                   	push   %esi
 94c:	e8 1d 01 00 00       	call   a6e <uswtch>
 ...
 959:	5d                   	pop    %ebp
 95a:	c3                   	ret
 95b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi

00000960 <thread_stub>:
static void thread_stub(void (*fn)(void*), void *arg) {
 960:	55                   	push   %ebp
 961:	89 e5                	mov    %esp,%ebp
 963:	83 ec 14             	sub    $0x14,%esp
  fn(arg);
 966:	ff 75 0c             	push   0xc(%ebp)
 969:	ff 55 08             	call   *0x8(%ebp)
  table[current].state = ZOMBIE;
 96c:	a1 54 0f 00 00       	mov    0xf54,%eax
 971:	c1 e0 04             	shl    $0x4,%eax
 974:	c7 80 60 0f 00 00 03 	movl   $0x3,0xf60(%eax)
 97b:	00 00 00 
  thread_yield();
 97e:	e8 3d ff ff ff       	call   8c0 <thread_yield>
  exit();
 983:	e8 ab f9 ff ff       	call   333 <exit>
 988:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 98f:	00 

00000990 <thread_join>:
...
int thread_join(tid_t tid) {
 ...
 9a0:	89 de                	mov    %ebx,%esi
 9a2:	c1 e6 04             	shl    $0x4,%esi
 9a5:	39 86 64 0f 00 00    	cmp    %eax,0xf64(%esi)
 9ab:	74 20                	je     9cd <thread_join+0x3d>
  for (int i = 0; i < MAX_THREADS; i++) {
 9ad:	83 c3 01             	add    $0x1,%ebx
 9b0:	83 fb 10             	cmp    $0x10,%ebx
 9b3:	75 eb                	jne    9a0 <thread_join+0x10>
  table[slot].state = FREE;
  table[slot].stack = 0;
  table[slot].ctx   = 0;
 
  return 0;
 9b5:	8d 65 f8             	lea    -0x8(%ebp),%esp
  if (slot == -1) return -1;
 ...
 9cd:	83 be 60 0f 00 00 03 	cmpl   $0x3,0xf60(%esi)
 9d4:	75 f2                	jne    9c8 <thread_join+0x38>
  if (table[slot].stack)
 9d6:	89 d8                	mov    %ebx,%eax
 9d8:	c1 e0 04             	shl    $0x4,%eax
 9db:	8b 80 68 0f 00 00    	mov    0xf68(%eax),%eax
 9e1:	85 c0                	test   %eax,%eax
 9e3:	74 0c                	je     9f1 <thread_join+0x61>
    free(table[slot].stack);
 9e5:	83 ec 0c             	sub    $0xc,%esp
 9e8:	50                   	push   %eax
 9e9:	e8 22 fc ff ff       	call   610 <free>
 9ee:	83 c4 10             	add    $0x10,%esp
  table[slot].state = FREE;
 9f1:	c1 e3 04             	shl    $0x4,%ebx
  return 0;
 9f4:	31 c0                	xor    %eax,%eax
  table[slot].state = FREE;
 9f6:	c7 83 60 0f 00 00 00 	movl   $0x0,0xf60(%ebx)
 9fd:	00 00 00 
  table[slot].stack = 0;
 a00:	c7 83 68 0f 00 00 00 	movl   $0x0,0xf68(%ebx)
 a07:	00 00 00 
  table[slot].ctx   = 0;
 a0a:	c7 83 6c 0f 00 00 00 	movl   $0x0,0xf6c(%ebx)
 a11:	00 00 00 
...
void mutex_lock(umutex_t *m){ while(m->locked){ thread_yield(); } m->locked = 1; }
 ...
 a40:	e8 7b fe ff ff       	call   8c0 <thread_yield>
...
uswtch:
  movl 4(%esp), %eax
 a6e:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
 a72:	8b 54 24 08          	mov    0x8(%esp),%edx
 ...
 a79:	57                   	push   %edi
  ...
  movl %esp, (%eax)
 a7a:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
 a7c:	89 d4                	mov    %edx,%esp
