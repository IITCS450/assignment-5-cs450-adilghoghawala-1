...
fork1(void)
{
  ...
  exit();
     ...
     105:	51                   	push   %ecx
     106:	68 c3 1d 00 00       	push   $0x1dc3
     10b:	68 0d 16 00 00       	push   $0x160d
     110:	6a 02                	push   $0x2
    ...
    panic("fork");
     ...
     122:	68 67 15 00 00       	push   $0x1567
...
00000130 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     13e:	68 64 15 00 00       	push   $0x1564
     143:	6a 02                	push   $0x2
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 01 16 00 00       	push   $0x1601
     17e:	6a 02                	push   $0x2
...
00000190 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     1a5:	68 67 15 00 00       	push   $0x1567
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 24 16 00 00 	jmp    *0x1624(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1e9:	68 73 15 00 00       	push   $0x1573
     1ee:	6a 02                	push   $0x2
    ...
    panic("runcmd");
     ...
     2cf:	68 93 15 00 00       	push   $0x1593
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 a0 1d 00 00       	push   $0x1da0
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 a0 1d 00 00       	push   $0x1da0
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     546:	50                   	push   %eax
     547:	68 98 1d 00 00       	push   $0x1d98
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     565:	50                   	push   %eax
     566:	68 a0 1d 00 00       	push   $0x1da0
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 a0 1d 00 00       	push   $0x1da0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     673:	68 b5 15 00 00       	push   $0x15b5
     678:	53                   	push   %ebx
     679:	56                   	push   %esi
  ...
  return cmd;
     ...
     78e:	68 98 15 00 00       	push   $0x1598
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     7af:	68 b8 15 00 00       	push   $0x15b8
     7b4:	56                   	push   %esi
     7b5:	53                   	push   %ebx
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     816:	68 cf 15 00 00       	push   $0x15cf
     81b:	56                   	push   %esi
     81c:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     860:	68 c1 15 00 00       	push   $0x15c1
  ...
  cmd->eargv[argc] = 0;
     ...
     8a9:	68 ba 15 00 00       	push   $0x15ba
...
000008c0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8d9:	68 d4 15 00 00       	push   $0x15d4
  cmd = parseexec(ps, es);
...
00000950 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     9ab:	68 d6 15 00 00       	push   $0x15d6
     9b0:	57                   	push   %edi
     9b1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9c1:	68 d2 15 00 00       	push   $0x15d2
     9c6:	57                   	push   %edi
     9c7:	56                   	push   %esi
...
00000a30 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a3f:	68 b8 15 00 00       	push   $0x15b8
     a44:	56                   	push   %esi
     a45:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a69:	68 f4 15 00 00       	push   $0x15f4
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ad5:	ff 24 85 3c 16 00 00 	jmp    *0x163c(,%eax,4)
     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 82 15 00 00       	push   $0x1582
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     bae:	52                   	push   %edx
     baf:	50                   	push   %eax
     bb0:	68 f6 15 00 00       	push   $0x15f6
     bb5:	6a 02                	push   $0x2
     bb7:	e8 a4 03 00 00       	call   f60 <printf>
    panic("syntax");
     bbc:	c7 04 24 ba 15 00 00 	movl   $0x15ba,(%esp)
     ...
     ec8:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     efb:	0f b6 92 ac 16 00 00 	movzbl 0x16ac(%edx),%edx
     ...
     f69:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fd4:	ff 24 85 54 16 00 00 	jmp    *0x1654(,%eax,4)
  ...
  write(fd, &c, 1);
    ...
    10e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    10e5:	bb 1b 16 00 00       	mov    $0x161b,%ebx
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10f1:	a1 24 1e 00 00       	mov    0x1e24,%eax
{
  ...
  freep = p;
    ...
    112f:	5b                   	pop    %ebx
  freep = p;
    1130:	a3 24 1e 00 00       	mov    %eax,0x1e24
}
    1135:	5e                   	pop    %esi
    1136:	5f                   	pop    %edi
    1137:	5d                   	pop    %ebp
    ...
    1146:	72 ce                	jb     1116 <free+0x26>
{
  ...
  freep = p;
    116a:	a3 24 1e 00 00       	mov    %eax,0x1e24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    118c:	8b 15 24 1e 00 00    	mov    0x1e24,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11cb:	3b 05 24 1e 00 00    	cmp    0x1e24,%eax
  ...
  return freep;
    11f3:	8b 15 24 1e 00 00    	mov    0x1e24,%edx
    ...
    121c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    121f:	89 15 24 1e 00 00    	mov    %edx,0x1e24
}
    ...
    122f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1230:	c7 05 24 1e 00 00 28 	movl   $0x1e28,0x1e24
    1237:	1e 00 00 
    base.s.size = 0;
    123a:	b8 28 1e 00 00       	mov    $0x1e28,%eax
    base.s.ptr = freep = prevp = &base;
    123f:	c7 05 28 1e 00 00 28 	movl   $0x1e28,0x1e28
    1246:	1e 00 00 
    base.s.size = 0;
    1249:	c7 05 2c 1e 00 00 00 	movl   $0x0,0x1e2c
    1250:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void) {
  ...
  for (int i = 0; i < MAX_THREADS; i++)
    1270:	b8 60 1e 00 00       	mov    $0x1e60,%eax
    1275:	8d 76 00             	lea    0x0(%esi),%esi
    table[i].state = FREE;
    1278:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
    127e:	83 c0 20             	add    $0x20,%eax
    table[i].state = FREE;
    1281:	c7 40 f0 00 00 00 00 	movl   $0x0,-0x10(%eax)
  for (int i = 0; i < MAX_THREADS; i++)
    1288:	3d 60 1f 00 00       	cmp    $0x1f60,%eax
    128d:	75 e9                	jne    1278 <thread_init+0x8>
 
  table[0].state = RUNNING;
  table[0].tid   = next_tid++;
    128f:	a1 a8 1d 00 00       	mov    0x1da8,%eax
  table[0].state = RUNNING;
    1294:	c7 05 60 1e 00 00 02 	movl   $0x2,0x1e60
    129b:	00 00 00 
  table[0].stack = 0;   
    129e:	c7 05 68 1e 00 00 00 	movl   $0x0,0x1e68
    12a5:	00 00 00 
  table[0].tid   = next_tid++;
    12a8:	8d 50 01             	lea    0x1(%eax),%edx
    12ab:	a3 64 1e 00 00       	mov    %eax,0x1e64
    12b0:	89 15 a8 1d 00 00    	mov    %edx,0x1da8
  table[0].ctx   = &main_ctx;
    12b6:	c7 05 6c 1e 00 00 40 	movl   $0x1e40,0x1e6c
    12bd:	1e 00 00 
  current = 0;
    12c0:	c7 05 54 1e 00 00 00 	movl   $0x0,0x1e54
    12c7:	00 00 00 
}
    12ca:	c3                   	ret
    12cb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
...
tid_t thread_create(void (*fn)(void*), void *arg) {
    ...
    12e0:	89 c3                	mov    %eax,%ebx
    12e2:	c1 e3 04             	shl    $0x4,%ebx
    12e5:	8b 93 60 1e 00 00    	mov    0x1e60(%ebx),%edx
    12eb:	85 d2                	test   %edx,%edx
    12ed:	74 19                	je     1308 <thread_create+0x38>
  for (int i = 1; i < MAX_THREADS; i++) {
    12ef:	83 c0 01             	add    $0x1,%eax
    12f2:	83 f8 10             	cmp    $0x10,%eax
    12f5:	75 e9                	jne    12e0 <thread_create+0x10>
  }
  if (slot == -1) return -1;
    12f7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    12fc:	e9 98 00 00 00       	jmp    1399 <thread_create+0xc9>
    1301:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 
  char *stk = malloc(STACK_SIZE);
    1308:	83 ec 0c             	sub    $0xc,%esp
    130b:	68 00 20 00 00       	push   $0x2000
    1310:	e8 6b fe ff ff       	call   1180 <malloc>
  if (!stk) return -1;
  ...
  if (!stk) return -1;
    ...
    131c:	74 d9                	je     12f7 <thread_create+0x27>
  memset(stk, 0, STACK_SIZE);
    131e:	83 ec 04             	sub    $0x4,%esp
    1321:	68 00 20 00 00       	push   $0x2000
    1326:	6a 00                	push   $0x0
    1328:	56                   	push   %esi
    1329:	e8 62 f9 ff ff       	call   c90 <memset>
  ...
  table[slot].stack = stk;
    1331:	89 b3 68 1e 00 00    	mov    %esi,0x1e68(%ebx)
  table[slot].ctx   = (struct context*)sp;

  return table[slot].tid;
    1337:	83 c4 10             	add    $0x10,%esp
  sp--;  *sp = 0xffffffff;
    133a:	c7 86 f4 1f 00 00 ff 	movl   $0xffffffff,0x1ff4(%esi)
    1341:	ff ff ff 
  sp--;  *sp = 0;   /* edi */
    1344:	81 c6 e0 1f 00 00    	add    $0x1fe0,%esi
  sp--;  *sp = (uint)arg;
    134a:	89 46 1c             	mov    %eax,0x1c(%esi)
  sp--;  *sp = (uint)fn;
    134d:	8b 45 08             	mov    0x8(%ebp),%eax
  sp--;  *sp = (uint)thread_stub;
    1350:	c7 46 10 40 14 00 00 	movl   $0x1440,0x10(%esi)
  sp--;  *sp = (uint)fn;
    1357:	89 46 18             	mov    %eax,0x18(%esi)
  table[slot].tid   = next_tid++;
    135a:	a1 a8 1d 00 00       	mov    0x1da8,%eax
  sp--;  *sp = 0;   /* ebp */
    135f:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
  table[slot].tid   = next_tid++;
    1366:	8d 48 01             	lea    0x1(%eax),%ecx
  sp--;  *sp = 0;   /* ebx */
    1369:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)
  sp--;  *sp = 0;   /* esi */
    1370:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
  sp--;  *sp = 0;   /* edi */
    1377:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  table[slot].state = RUNNABLE;
    137d:	c7 83 60 1e 00 00 01 	movl   $0x1,0x1e60(%ebx)
    1384:	00 00 00 
  table[slot].tid   = next_tid++;
    1387:	89 0d a8 1d 00 00    	mov    %ecx,0x1da8
    138d:	89 83 64 1e 00 00    	mov    %eax,0x1e64(%ebx)
  sp--;  *sp = 0;   /* edi */
    1393:	89 b3 6c 1e 00 00    	mov    %esi,0x1e6c(%ebx)
}
    1399:	8d 65 f8             	lea    -0x8(%ebp),%esp
    139c:	5b                   	pop    %ebx
    139d:	5e                   	pop    %esi
    139e:	5d                   	pop    %ebp
    139f:	c3                   	ret
...
void thread_yield(void) {
    ...
    13a5:	8b 35 54 1e 00 00    	mov    0x1e54,%esi
    13ab:	8d 4e 01             	lea    0x1(%esi),%ecx
    13ae:	8d 5e 11             	lea    0x11(%esi),%ebx
    13b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13b8:	89 ca                	mov    %ecx,%edx
    13ba:	c1 fa 1f             	sar    $0x1f,%edx
    13bd:	c1 ea 1c             	shr    $0x1c,%edx
    13c0:	8d 04 11             	lea    (%ecx,%edx,1),%eax
    13c3:	83 e0 0f             	and    $0xf,%eax
    13c6:	29 d0                	sub    %edx,%eax
    if (table[idx].state == RUNNABLE)
    13c8:	89 c2                	mov    %eax,%edx
    13ca:	c1 e2 04             	shl    $0x4,%edx
    13cd:	83 ba 60 1e 00 00 01 	cmpl   $0x1,0x1e60(%edx)
    13d4:	74 12                	je     13e8 <thread_yield+0x48>
  for (int i = 1; i <= MAX_THREADS; i++) {
    13d6:	83 c1 01             	add    $0x1,%ecx
    13d9:	39 d9                	cmp    %ebx,%ecx
    13db:	75 db                	jne    13b8 <thread_yield+0x18>
  ...
  if (next == -1) return;
    13e8:	83 f8 ff             	cmp    $0xffffffff,%eax
    13eb:	74 f0                	je     13dd <thread_yield+0x3d>
  if (table[prev].state == RUNNING)
    13ed:	89 f2                	mov    %esi,%edx
    13ef:	c1 e2 04             	shl    $0x4,%edx
    13f2:	83 ba 60 1e 00 00 02 	cmpl   $0x2,0x1e60(%edx)
    13f9:	75 0a                	jne    1405 <thread_yield+0x65>
    table[prev].state = RUNNABLE;
    13fb:	c7 82 60 1e 00 00 01 	movl   $0x1,0x1e60(%edx)
    1402:	00 00 00 
  table[next].state = RUNNING;
    1405:	89 c2                	mov    %eax,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
    1407:	c1 e6 04             	shl    $0x4,%esi
    140a:	83 ec 08             	sub    $0x8,%esp
  current = next;
    140d:	a3 54 1e 00 00       	mov    %eax,0x1e54
  table[next].state = RUNNING;
    1412:	c1 e2 04             	shl    $0x4,%edx
  uswtch(&table[prev].ctx, table[next].ctx);
    1415:	81 c6 6c 1e 00 00    	add    $0x1e6c,%esi
  table[next].state = RUNNING;
    141b:	c7 82 60 1e 00 00 02 	movl   $0x2,0x1e60(%edx)
    1422:	00 00 00 
  uswtch(&table[prev].ctx, table[next].ctx);
    1425:	ff b2 6c 1e 00 00    	push   0x1e6c(%edx)
    142b:	56                   	push   %esi
    142c:	e8 1d 01 00 00       	call   154e <uswtch>
...
00001440 <thread_stub>:
static void thread_stub(void (*fn)(void*), void *arg) {
    1440:	55                   	push   %ebp
    1441:	89 e5                	mov    %esp,%ebp
    1443:	83 ec 14             	sub    $0x14,%esp
  fn(arg);
    1446:	ff 75 0c             	push   0xc(%ebp)
    1449:	ff 55 08             	call   *0x8(%ebp)
  table[current].state = ZOMBIE;
    144c:	a1 54 1e 00 00       	mov    0x1e54,%eax
    1451:	c1 e0 04             	shl    $0x4,%eax
    1454:	c7 80 60 1e 00 00 03 	movl   $0x3,0x1e60(%eax)
    145b:	00 00 00 
  thread_yield();
    145e:	e8 3d ff ff ff       	call   13a0 <thread_yield>
  exit();
    1463:	e8 ab f9 ff ff       	call   e13 <exit>
    1468:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    146f:	00 

00001470 <thread_join>:
...
int thread_join(tid_t tid) {
  ...
  for (int i = 0; i < MAX_THREADS; i++) {
    ...
    1480:	89 de                	mov    %ebx,%esi
    1482:	c1 e6 04             	shl    $0x4,%esi
    1485:	39 86 64 1e 00 00    	cmp    %eax,0x1e64(%esi)
    148b:	74 20                	je     14ad <thread_join+0x3d>
  for (int i = 0; i < MAX_THREADS; i++) {
    148d:	83 c3 01             	add    $0x1,%ebx
    1490:	83 fb 10             	cmp    $0x10,%ebx
    1493:	75 eb                	jne    1480 <thread_join+0x10>
  table[slot].state = FREE;
  table[slot].stack = 0;
  table[slot].ctx   = 0;
 
  return 0;
    1495:	8d 65 f8             	lea    -0x8(%ebp),%esp
  if (slot == -1) return -1;
    1498:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    149d:	5b                   	pop    %ebx
    149e:	5e                   	pop    %esi
    149f:	5d                   	pop    %ebp
    14a0:	c3                   	ret
  ...
  while (table[slot].state != ZOMBIE)
    14ad:	83 be 60 1e 00 00 03 	cmpl   $0x3,0x1e60(%esi)
    14b4:	75 f2                	jne    14a8 <thread_join+0x38>
  if (table[slot].stack)
    14b6:	89 d8                	mov    %ebx,%eax
    14b8:	c1 e0 04             	shl    $0x4,%eax
    14bb:	8b 80 68 1e 00 00    	mov    0x1e68(%eax),%eax
    14c1:	85 c0                	test   %eax,%eax
    14c3:	74 0c                	je     14d1 <thread_join+0x61>
    free(table[slot].stack);
    14c5:	83 ec 0c             	sub    $0xc,%esp
    14c8:	50                   	push   %eax
    14c9:	e8 22 fc ff ff       	call   10f0 <free>
    14ce:	83 c4 10             	add    $0x10,%esp
  table[slot].state = FREE;
    14d1:	c1 e3 04             	shl    $0x4,%ebx
  return 0;
    14d4:	31 c0                	xor    %eax,%eax
  table[slot].state = FREE;
    14d6:	c7 83 60 1e 00 00 00 	movl   $0x0,0x1e60(%ebx)
    14dd:	00 00 00 
  table[slot].stack = 0;
    14e0:	c7 83 68 1e 00 00 00 	movl   $0x0,0x1e68(%ebx)
    14e7:	00 00 00 
  table[slot].ctx   = 0;
    14ea:	c7 83 6c 1e 00 00 00 	movl   $0x0,0x1e6c(%ebx)
    14f1:	00 00 00 
...
void mutex_init(umutex_t *m){ m->locked = 0; }
    ...
    1506:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    150c:	5d                   	pop    %ebp
    150d:	c3                   	ret
...
void mutex_lock(umutex_t *m){ while(m->locked){ thread_yield(); } m->locked = 1; }
    ...
    151a:	8b 03                	mov    (%ebx),%eax
    151c:	85 c0                	test   %eax,%eax
    151e:	74 0b                	je     152b <mutex_lock+0x1b>
    1520:	e8 7b fe ff ff       	call   13a0 <thread_yield>
    1525:	8b 03                	mov    (%ebx),%eax
    1527:	85 c0                	test   %eax,%eax
    1529:	75 f5                	jne    1520 <mutex_lock+0x10>
    152b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
    1531:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    1534:	c9                   	leave
    1535:	c3                   	ret
    1536:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    153d:	00 
    153e:	66 90                	xchg   %ax,%ax

00001540 <mutex_unlock>:
void mutex_unlock(umutex_t *m){ m->locked = 0; }
    1540:	55                   	push   %ebp
    1541:	89 e5                	mov    %esp,%ebp
    1543:	8b 45 08             	mov    0x8(%ebp),%eax
    1546:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    154c:	5d                   	pop    %ebp
    154d:	c3                   	ret
...
uswtch:
  movl 4(%esp), %eax
    154e:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
    1552:	8b 54 24 08          	mov    0x8(%esp),%edx
  ...
  movl %esp, (%eax)
    155a:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
    155c:	89 d4                	mov    %edx,%esp
